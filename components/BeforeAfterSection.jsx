...
const COPY = {
  es: { label: 'ANTES / DESPUÉS', titleA: 'Contenido real vs', highlight: 'Contenido IA', sub: 'Toca la imagen y descubre la transformación: la misma persona, otro nivel.', before: 'Contenido real', after: 'Contenido IA' },
  en: { label: 'BEFORE / AFTER', titleA: 'Real content vs', highlight: 'AI content', sub: 'Tap the image and watch the transformation: same person, next level.', before: 'Real content', after: 'AI content' },
  ...
  de: { label: 'VORHER / NACHHER', titleA: 'Echter Content vs', highlight: 'KI-Content', sub: 'Tippe das Bild an und sieh die Verwandlung: dieselbe Person, ein anderes Level.', before: 'Echter Content', after: 'KI-Content' },
