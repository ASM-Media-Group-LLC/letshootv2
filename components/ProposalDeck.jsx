...
export default function ProposalDeck({ creatorName, intro, slides = [], onClose, onChoosePack, chosenPack, packDisabled }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] overflow-y-auto bg-ink text-paper">
      ...
      {/* ── PORTADA — cinemática, ocupa 90vh ──────────────────────────────── */}
      <section className="relative z-10 flex min-h-[85vh] items-center px-6 sm:px-10">
        <div className="mx-auto w-full max-w-5xl">
          <motion.div
            initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease }}
            className="mb-8 inline-flex items-center gap-2 rounded-full border border-brand/30 bg-brand/[0.08] px-4 py-1.5 font-mono text-[11px] font-bold uppercase tracking-[0.22em] text-brand backdrop-blur"
          >
          ...
          <motion.h1
            ...
            className="font-display text-[clamp(2.4rem,7vw,5rem)] font-bold leading-[0.98] tracking-[-0.03em]"
          >
            Así se vería
          ...
          <motion.p
            ...
            className="mt-8 max-w-2xl text-balance text-lg leading-relaxed text-paper-mute sm:text-xl"
          >
          ...
          <motion.div
            ...
            className="mt-14 flex items-center gap-3 text-xs text-paper-dim"
          >
            ...
            <div className="h-px flex-1 bg-gradient-to-r from-brand/60 via-white/10 to-transparent" />
          </motion.div>
        </div>
      </section>

      {/* ── Cómo leer ─────────────────────────────────────────────────────── */}
      <section className="relative z-10 border-t border-white/[0.05] px-6 py-20 sm:px-10">
      ...
      {/* ── Trípticos ─────────────────────────────────────────────────────── */}
      <section className="relative z-10 border-t border-white/[0.05] px-6 py-24 sm:px-10">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-3 max-w-xl text-base text-paper-mute">Cada tríptico muestra la referencia, la foto real base y el resultado que entrega tu clon.</p>
