...
// Packs + billing periods live in lib/packs.js (single source of truth, also
// used by onboarding checkout and the Manual Sales package preselect).
import { PACKS, PERIODS } from '@/lib/packs';
export { PACKS, PERIODS };
