...
export const dict = {
  ...
  es: {
    ...
    finalCta: { titleA: 'Despide a tu fotógrafo', highlight: 'hoy', body: 'Nosotros creamos todo tu contenido que vende — fotos y videos listos para publicar. Tú solo apruebas.', cta: 'Empezar ahora' },
    footer: {
  ...
  en: {
    ...
    finalCta: { titleA: 'Fire your photographer', highlight: 'today', body: 'We create all your content that sells — photos and videos ready to post. You just approve.', cta: 'Start now' },
    footer: {
