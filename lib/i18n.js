...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      platformsLabel: 'Para vender en OnlyFans y traer tráfico desde redes',
  ...
  en: {
    ...
    hero: {
      ...
      platformsLabel: 'To sell on OnlyFans and drive traffic from social',
  ...
  pt: {
    ...
    hero: {
      ...
      platformsLabel: 'Para vender no OnlyFans e trazer tráfego das redes',
  ...
  fr: {
    ...
    hero: {
      ...
      platformsLabel: 'Pour vendre sur OnlyFans et amener du trafic des réseaux',
  ...
  de: {
    ...
    hero: {
      ...
      platformsLabel: 'Zum Verkauf auf OnlyFans und Traffic aus Social Media',
  ...
  it: {
    ...
    hero: {
      ...
      platformsLabel: 'Per vendere su OnlyFans e portare traffico dai social',
  ...
  zh: {
    ...
    hero: {
      ...
      platformsLabel: '在 OnlyFans 变现，并从社交平台引流',
