...
export const dict = {
  ...
  pt: {
    ...
    hero: {
      eyebrow: 'O TEU FOTÓGRAFO IA · SEMPRE DISPONÍVEL',
      pre: 'Conhece o teu',
      highlight: 'fotógrafo IA',
    ...
    finalCta: { titleA: 'Conhece o teu fotógrafo IA', highlight: 'hoje', body: 'Fotos e vídeos profissionais em qualquer lugar, quando quiseres, sem precisares de estar lá.', cta: 'Começar agora' },
    footer: {
  ...
  fr: {
    ...
    hero: {
      eyebrow: 'TON PHOTOGRAPHE IA · TOUJOURS DISPONIBLE',
      pre: 'Découvre ton',
      highlight: 'photographe IA',
