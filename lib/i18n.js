...
export const dict = {
  ...
  es: {
    ...
    pricing: {
      ...
      sub: 'Desde tu primera sesión gratis hasta atención personalizada. Cancela cuando quieras.',
  ...
  en: {
    ...
    pricing: {
      ...
      sub: 'From your first free session to personalized attention. Cancel anytime.',
