...
export const dict = {
  ...
  fr: {
    ...
    finalCta: { titleA: 'Rencontre ton photographe IA', highlight: 'aujourd’hui', body: 'Des photos et vidéos pro partout, quand tu veux, sans avoir à être là.', cta: 'Commencer maintenant' },
    footer: {
  ...
  de: {
    ...
    hero: {
      eyebrow: 'DEIN KI-FOTOGRAF · IMMER VERFÜGBAR',
      pre: 'Triff deinen',
      highlight: 'KI-Fotografen',
    ...
    finalCta: { titleA: 'Triff deinen KI-Fotografen', highlight: 'heute', body: 'Professionelle Fotos und Videos überall, wann immer du willst, ohne vor Ort sein zu müssen.', cta: 'Jetzt starten' },
    footer: {
  ...
  it: {
    ...
    hero: {
      eyebrow: 'IL TUO FOTOGRAFO IA · SEMPRE DISPONIBILE',
      pre: 'Incontra il tuo',
      highlight: 'fotografo IA',
    ...
    finalCta: { titleA: 'Incontra il tuo fotografo IA', highlight: 'oggi', body: 'Foto e video professionali ovunque, quando vuoi, senza dover essere lì.', cta: 'Inizia ora' },
    footer: {
  ...
  zh: {
    ...
    finalCta: { titleA: '今天就认识你的', highlight: 'AI 摄影师', body: '随时随地获得专业照片和视频，无需亲临现场。', cta: '立即开始' },
    footer: {
      tagline: '你的 AI 摄影师。',
      cols: [
