...
export const dict = {
  ...
  pt: {
    ...
    pricing: {
      ...
      sub: 'Da tua primeira sessão grátis até atenção personalizada. Cancela quando quiseres.',
  ...
  fr: {
    ...
    pricing: {
      ...
      sub: 'De ta première séance gratuite à une attention personnalisée. Annule quand tu veux.',
  ...
  de: {
    ...
    pricing: {
      ...
      sub: 'Von deiner ersten kostenlosen Session bis zur persönlichen Betreuung. Jederzeit kündbar.',
  ...
  it: {
    ...
    pricing: {
      ...
      sub: 'Dalla tua prima sessione gratis fino all’attenzione personalizzata. Disdici quando vuoi.',
