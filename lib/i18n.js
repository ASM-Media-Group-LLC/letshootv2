...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      body: 'Recibe paquetes curados de fotos y videos cortos para PPV, ventas por chat y pedidos personalizados — sin contratar fotógrafo, locación, maquillaje, luces ni equipo de producción.',
  ...
  en: {
    ...
    hero: {
      ...
      body: 'Get curated photo and short-video packs designed for PPV, chat sales and custom-style fan requests — without booking a photographer, location, makeup, lighting or production team.',
