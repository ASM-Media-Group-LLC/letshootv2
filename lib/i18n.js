...
export const dict = {
  ...
  es: {
    ...
    hero: {
      eyebrow: 'TU FOTÓGRAFO IA · SIEMPRE DISPONIBLE',
      pre: 'Conoce a tu',
      highlight: 'fotógrafo IA',
      body: 'Tu fotógrafo IA genera fotos y videos de nivel editorial desde cualquier lugar — sin estudio, sin esperas. Para creadores y agencias que nunca paran.',
      ctaPrimary: 'Crear mis fotos',
    ...
    creators: {
      ...
      sub: 'Sesiones de foto y video sin salir de casa. La misma tú, mejores resultados.',
      items: [
    ...
    comparison: {
      label: 'COMPARACIÓN', titleA: 'Shoot tradicional vs', titleHighlight: 'LetShoot',
      col1: 'Shoot tradicional', col2: 'LetShoot',
      rows: [
        { label: 'Fotógrafo', trad: '$500 - $800', ls: 'Incluido' },
        { label: 'Maquillaje', trad: '$100 - $200', ls: 'Incluido' },
        { label: 'Locación', trad: '$150 - $500', ls: 'Incluido' },
        { label: 'Transporte', trad: '$50 - $100', ls: 'Incluido' },
        { label: 'Tiempo', trad: '5 - 7 horas', ls: 'Minutos' },
        { label: 'Fotos + videos', trad: '20-30 fotos, 1 video', ls: 'Ilimitados' },
      ],
      totalLabel: 'Total', totalTrad: '$800 - $1.600', totalLs: 'Desde $29/mes',
    },
    results: {
    ...
    pricing: {
      label: 'PRECIOS', titleA: 'Créditos simples.', titleHighlight: 'Sin sorpresas.',
      sub: 'Un crédito, un resultado. Cada foto y video es curado artesanalmente por nuestro equipo. Mismo precio para todos.',
    ...
    finalCta: { titleA: 'Conoce a tu fotógrafo IA', highlight: 'hoy', body: 'Fotos y videos profesionales en cualquier lugar, cuando quieras, sin necesidad de estar ahí.', cta: 'Empezar ahora' },
    footer: {
      tagline: 'Tu fotógrafo IA.',
      cols: [
  ...
  en: {
    ...
    hero: {
      eyebrow: 'YOUR AI PHOTOGRAPHER · ALWAYS ON',
      pre: 'Meet your',
      highlight: 'AI photographer',
      body: 'Your AI photographer generates editorial-level photos and videos from anywhere — no studio, no waiting. For creators and agencies that never stop.',
      ctaPrimary: 'Create my photos',
    ...
    creators: {
      ...
      sub: 'Photo and video sessions without leaving home. The same you, better results.',
      items: [
    ...
    comparison: {
      label: 'COMPARISON', titleA: 'Traditional shoot vs', titleHighlight: 'LetShoot',
      col1: 'Traditional shoot', col2: 'LetShoot',
      rows: [
        { label: 'Photographer', trad: '$500 - $800', ls: 'Included' },
        { label: 'Makeup artist', trad: '$100 - $200', ls: 'Included' },
        { label: 'Location', trad: '$150 - $500', ls: 'Included' },
        { label: 'Transport', trad: '$50 - $100', ls: 'Included' },
        { label: 'Time', trad: '5 - 7 hours', ls: 'Minutes' },
        { label: 'Photos + videos', trad: '20-30 photos, 1 video', ls: 'Unlimited' },
      ],
      totalLabel: 'Total', totalTrad: '$800 - $1,600', totalLs: 'From $29/mo',
    },
    results: {
    ...
    pricing: {
      label: 'PRICING', titleA: 'Simple credits.', titleHighlight: 'No surprises.',
      sub: 'One credit, one result. Every photo and video is artisan-curated by our team. Same price for everyone.',
    ...
    finalCta: { titleA: 'Meet your AI photographer', highlight: 'today', body: 'Professional photos and videos anywhere, anytime, without needing to be there.', cta: 'Start now' },
    footer: {
      tagline: 'Your AI photographer.',
      cols: [
  ...
  pt: {
    ...
    hero: {
      eyebrow: 'O TEU FOTÓGRAFO IA · UM CLONE QUE NUNCA PARA',
      pre: 'Diz adeus ao teu',
      highlight: 'fotógrafo',
      body: 'Cria o teu clone digital e gera fotos e vídeos de nível editorial de qualquer lugar, para criadores e agências que nunca param.',
      ctaPrimary: 'Criar meu clone',
      ctaSecondary: 'Ver resultados',
    ...
    how: {
      label: 'COMO FUNCIONA', titleA: '3 passos para o teu', titleHighlight: 'clone digital',
      ...
      steps: [
        ...
        { n: '02', icon: 'cpu', t: 'Criamos o teu clone', d: 'A nossa equipa treina o teu clone digital com contexto único. Pronto em horas.' },
    ...
    comparison: {
      ...
      totalLabel: 'Total', totalTrad: '$800 - $1.600', totalLs: 'Desde $29/mês',
    },
    results: {
    ...
    pricing: {
      label: 'PREÇOS', titleA: 'Créditos simples.', titleHighlight: 'Sem surpresas.',
      sub: 'Um crédito, um resultado. Cada foto e vídeo é curado à mão pela nossa equipa. Mesmo preço para todos.',
      toggleCreators: 'Criadores', toggleAgencies: 'Agências', popular: 'Mais popular', perMonth: '/mês',
      plans: {
        creators: [
          { name: 'Free', price: '$0', cta: 'Começar grátis', features: ['0 créditos reais', '1 clone digital', '3 locações base', 'Resolução padrão', 'Com marca de água'] },
          { name: 'Starter', price: '$29', cta: 'Escolher Starter', features: ['50 créditos / mês', '1 clone digital completo', '10 locações', 'Resolução HD (1024px)', 'Sem marca de água'] },
          { name: 'Pro', price: '$79', popular: true, cta: 'Escolher Pro', features: ['200 créditos / mês', 'Até 3 clones digitais', 'Todas as locações', 'Ultra HD (2048px)', 'Fila prioritária'] },
          { name: 'Enterprise', price: 'Custom', cta: 'Contactar vendas', features: ['Créditos personalizados', 'Clones ilimitados', 'Todas as locações', 'Ultra HD (2048px)', 'Gestor de conta dedicado'] },
        ],
        agencies: [
          { name: 'Team', price: '$149', cta: 'Escolher Team', features: ['1.000 créditos / mês', 'Até 10 clones', 'Dashboard de talento', 'Ultra HD (2048px)', 'Suporte prioritário'] },
          { name: 'Studio', price: '$399', popular: true, cta: 'Escolher Studio', features: ['3.000 créditos / mês', 'Clones ilimitados', 'Produção em massa', 'Analítica avançada', 'Acesso à API'] },
    ...
    finalCta: { titleA: 'Cria o teu clone digital', highlight: 'hoje', body: 'Fotos e vídeos profissionais em qualquer lugar, quando quiseres, sem precisares de estar lá.', cta: 'Começar agora' },
    footer: {
  ...
  fr: {
    ...
    hero: {
      eyebrow: 'TON PHOTOGRAPHE IA · UN CLONE QUI NE S’ARRÊTE JAMAIS',
      pre: 'Dis adieu à ton',
      highlight: 'photographe',
      body: 'Crée ton clone numérique et génère des photos et vidéos de niveau éditorial depuis n’importe où, pour les créateurs et agences qui ne s’arrêtent jamais.',
      ctaPrimary: 'Créer mon clone',
    ...
    how: {
      label: 'COMMENT ÇA MARCHE', titleA: '3 étapes vers ton', titleHighlight: 'clone numérique',
      ...
      steps: [
        ...
        { n: '02', icon: 'cpu', t: 'On crée ton clone', d: 'Notre équipe entraîne ton clone numérique avec un contexte unique. Prêt en quelques heures.' },
    ...
    comparison: {
      ...
      totalLabel: 'Total', totalTrad: '$800 - $1 600', totalLs: 'Dès $29/mois',
    },
    results: {
    ...
    pricing: {
      label: 'TARIFS', titleA: 'Crédits simples.', titleHighlight: 'Sans surprises.',
      sub: 'Un crédit, un résultat. Chaque photo et vidéo est curée à la main par notre équipe. Même prix pour tous.',
    ...
    finalCta: { titleA: 'Crée ton clone numérique', highlight: 'aujourd’hui', body: 'Des photos et vidéos pro partout, quand tu veux, sans avoir à être là.', cta: 'Commencer maintenant' },
    footer: {
  ...
  de: {
    ...
    hero: {
      eyebrow: 'DEIN KI-FOTOGRAF · EIN KLON, DER NIE PAUSIERT',
      pre: 'Sag deinem',
      highlight: 'Fotografen',
      body: 'Erstelle deinen digitalen Klon und generiere Fotos und Videos auf Editorial-Niveau von überall — für Creator und Agenturen, die nie stoppen.',
      ctaPrimary: 'Meinen Klon erstellen',
    ...
    how: {
      label: 'SO FUNKTIONIERT’S', titleA: '3 Schritte zu deinem', titleHighlight: 'digitalen Klon',
      ...
      steps: [
        ...
        { n: '02', icon: 'cpu', t: 'Wir erstellen deinen Klon', d: 'Unser Team trainiert deinen digitalen Klon mit einzigartigem Kontext. In Stunden fertig.' },
    ...
    comparison: {
      ...
      totalLabel: 'Gesamt', totalTrad: '$800 - $1.600', totalLs: 'Ab $29/Monat',
    },
    results: {
    ...
    pricing: {
      label: 'PREISE', titleA: 'Einfache Credits.', titleHighlight: 'Keine Überraschungen.',
      sub: 'Ein Credit, ein Ergebnis. Jedes Foto und Video wird von unserem Team handkuratiert. Gleicher Preis für alle.',
    ...
    finalCta: { titleA: 'Erstelle deinen digitalen Klon', highlight: 'heute', body: 'Professionelle Fotos und Videos überall, wann immer du willst, ohne vor Ort sein zu müssen.', cta: 'Jetzt starten' },
    footer: {
  ...
  it: {
    ...
    hero: {
      eyebrow: 'IL TUO FOTOGRAFO IA · UN CLONE CHE NON SI FERMA MAI',
      pre: 'Di’ addio al tuo',
      highlight: 'fotografo',
      body: 'Crea il tuo clone digitale e genera foto e video di livello editoriale da ovunque, per creator e agenzie che non si fermano mai.',
      ctaPrimary: 'Crea il mio clone',
    ...
    how: {
      label: 'COME FUNZIONA', titleA: '3 passi verso il tuo', titleHighlight: 'clone digitale',
      ...
      steps: [
        ...
        { n: '02', icon: 'cpu', t: 'Creiamo il tuo clone', d: 'Il nostro team allena il tuo clone digitale con un contesto unico. Pronto in poche ore.' },
    ...
    comparison: {
      ...
      totalLabel: 'Totale', totalTrad: '$800 - $1.600', totalLs: 'Da $29/mese',
    },
    results: {
    ...
    pricing: {
      label: 'PREZZI', titleA: 'Crediti semplici.', titleHighlight: 'Nessuna sorpresa.',
      sub: 'Un credito, un risultato. Ogni foto e video è curato a mano dal nostro team. Stesso prezzo per tutti.',
    ...
    finalCta: { titleA: 'Crea il tuo clone digitale', highlight: 'oggi', body: 'Foto e video professionali ovunque, quando vuoi, senza dover essere lì.', cta: 'Inizia ora' },
    footer: {
  ...
  zh: {
    ...
    hero: {
      eyebrow: '你的 AI 摄影师 · 永不停歇的数字分身',
      pre: '告别你的',
      highlight: '摄影师',
      body: '创建你的数字分身，随时随地生成杂志级的照片和视频——为永不停歇的创作者和机构而生。',
      ctaPrimary: '创建我的分身',
      ctaSecondary: '查看案例',
    ...
    how: {
      label: '如何运作', titleA: '三步拥有你的', titleHighlight: '数字分身',
      sub: '几分钟内，从自拍到专业大片。',
      steps: [
        { n: '01', icon: 'upload', t: '上传你的自拍', d: '上传 10-20 张不同角度的自拍，剩下的交给我们。' },
        { n: '02', icon: 'cpu', t: '我们创建你的分身', d: '我们的团队用专属语境训练你的数字分身，数小时即可完成。' },
    ...
    comparison: {
      ...
      totalLabel: '合计', totalTrad: '$800 - $1,600', totalLs: '$29/月起',
    },
    results: {
    ...
    pricing: {
      label: '价格', titleA: '简单的积分。', titleHighlight: '没有意外。',
      sub: '一个积分，一个成果。每张照片和视频都由我们的团队精心打磨。所有人同价。',
    ...
    finalCta: { titleA: '今天就创建你的数字分身', highlight: '', body: '随时随地获得专业照片和视频，无需亲临现场。', cta: '立即开始' },
    footer: {
      tagline: '你的 AI 摄影师。',
      cols: [
