...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      pre: 'Contenido de venta para OnlyFans —',
      highlight: 'sin el costo de producción',
      body: 'Crear buen contenido es caro y lento — y a la hora de vender, tu fan no espera. Te damos contenido de venta al instante para que nunca frenes una compra en un chat, un PPV o un pedido. Ese es el problema que resolvemos.',
  ...
  en: {
    ...
    hero: {
      ...
      pre: 'Custom sales content for OnlyFans —',
      highlight: 'without the production cost',
      body: 'Great content is expensive and slow — and when your fan is ready to buy, they won’t wait. We hand you sell-ready content on demand, so you never stall a sale in a chat, a PPV or a custom request. That’s the problem we solve.',
