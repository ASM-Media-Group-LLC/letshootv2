...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      pre: 'Clona tu cara y tu voz. Contenido listo para vender.',
      sub: 'Fotos, vídeos y audios con tu cara y tu voz, listos para vender — sin producción.',
      highlight: 'tu cara y tu voz, listo para vender, sin producción',
  ...
  en: {
    ...
    hero: {
      ...
      pre: 'Clone your face and your voice. Content ready to sell.',
      sub: 'Photos, videos and audios with your face and your voice, ready to sell — no production.',
      highlight: 'your face and your voice, ready to sell, no production',
  ...
  pt: {
    ...
    hero: {
      ...
      pre: 'Clona a tua cara e a tua voz. Conteúdo pronto para vender.',
      sub: 'Fotos, vídeos e áudios com a tua cara e a tua voz, prontos para vender — sem produção.',
      highlight: 'a tua cara e a tua voz, pronto para vender, sem produção',
  ...
  fr: {
    ...
    hero: {
      ...
      pre: 'Clone ton visage et ta voix. Du contenu prêt à vendre.',
      sub: 'Photos, vidéos et audios avec ton visage et ta voix, prêts à vendre — sans production.',
      highlight: 'ton visage et ta voix, prêt à vendre, sans production',
  ...
  de: {
    ...
    hero: {
      ...
      pre: 'Klone dein Gesicht und deine Stimme. Verkaufsbereiter Content.',
      sub: 'Fotos, Videos und Audios mit deinem Gesicht und deiner Stimme, verkaufsbereit — ohne Produktion.',
      highlight: 'dein Gesicht und deine Stimme, verkaufsbereit, ohne Produktion',
  ...
  it: {
    ...
    hero: {
      ...
      pre: 'Clona il tuo viso e la tua voce. Contenuto pronto da vendere.',
      sub: 'Foto, video e audio con il tuo viso e la tua voce, pronti da vendere — senza produzione.',
      highlight: 'il tuo viso e la tua voce, pronto da vendere, senza produzione',
  ...
  zh: {
    ...
    hero: {
      ...
      pre: '克隆你的面孔与声音。内容即可变现。',
      sub: '带着你面孔和声音的照片、视频和音频，即可变现——无需拍摄制作。',
      highlight: '你的面孔与声音, 即可变现, 无需制作',
