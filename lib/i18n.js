...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      pre: 'Despide a tu',
      highlight: 'fotógrafo',
      body: 'Tú ya vendes tu contenido. Ahora prodúcelo tú misma: fotos y videos que venden, sin fotógrafo, sin estudio y sin esperas. Listo en minutos, desde tu casa.',
    ...
    finalCta: { titleA: 'Despide a tu fotógrafo', highlight: 'hoy', body: 'Empieza a producir tu propio contenido que vende — sin fotógrafo, sin estudio, sin esperas. Tú al mando.', cta: 'Empezar ahora' },
    footer: {
  ...
  en: {
    ...
    hero: {
      ...
      body: 'You already sell your content. Now produce it yourself: photos and videos that sell — no photographer, no studio, no waiting. Ready in minutes, from home.',
    ...
    finalCta: { titleA: 'Fire your photographer', highlight: 'today', body: 'Start producing your own content that sells — no photographer, no studio, no waiting. You are in charge.', cta: 'Start now' },
    footer: {
