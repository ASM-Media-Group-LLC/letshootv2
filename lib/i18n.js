...
export const dict = {
  // ════════════════════════════════════════════════════════════ ES
  es: {
    nav: { creators: 'Creadores', agencies: 'Agencias', pricing: 'Precios', results: 'Resultados', cta: 'Empezar gratis', delivery: 'Cómo funciona', packages: 'Paquetes', howWeWork: 'Cómo trabajamos' },
    hero: {
      eyebrow: 'PARA CREADORAS DE ONLYFANS', eyebrowPre: 'Para creadoras de', eyebrowPost: '',
      pre: 'Clona tu cara y tu voz. Contenido que engancha y vende.',
      sub: 'Fotos, vídeos y audios con tu cara y tu voz para enganchar fans, atraer tráfico y vender — sin producción.',
      highlight: 'tu cara y tu voz, engancha y vende, sin producción',
      ...
      platformsSellOn: 'Engancha en', platformsTrafficFrom: 'y trae tráfico desde',
      ctaPrimary: '¿Por qué lo necesitas?',
    ...
    voice: {
      label: 'AHORA TAMBIÉN LA VOZ', titleA: 'No solo su cara —', highlight: 'también su voz',
      sub: 'Ahora clonamos también su voz. Audios personalizados para tus fans — con su voz, en su idioma, sin que tenga que grabar nada.',
      badge: 'Su voz · Su idioma',
      cases: [
        { t: 'Bienvenida con su voz', d: 'Cada nuevo fan recibe un audio de bienvenida hablado con su propia voz.' },
        { t: 'Audios PPV', d: 'Mensajes de voz de pago, listos para vender en el chat.' },
        { t: 'Mensajes personalizados', d: 'Audios a medida para sus VIP, con su nombre y en su idioma.' },
      ],
      note: 'Su voz, en su idioma, sin grabar cada vez.',
    },
    comparison: {
  ...
  // ════════════════════════════════════════════════════════════ EN
  en: {
    nav: { creators: 'Creators', agencies: 'Agencies', pricing: 'Pricing', results: 'Results', cta: 'Start free', delivery: 'How it works', packages: 'Packages', howWeWork: 'How we work' },
    hero: {
      eyebrow: 'FOR ONLYFANS CREATORS', eyebrowPre: 'For', eyebrowPost: 'creators',
      pre: 'Clone your face and your voice. Content that hooks and sells.',
      sub: 'Photos, videos and audios with your face and your voice to hook fans, pull in traffic and sell — no production.',
      highlight: 'your face and your voice, hooks and sells, no production',
      ...
      platformsSellOn: 'Engage on', platformsTrafficFrom: 'and drive traffic from',
      ctaPrimary: 'Why you need this',
    ...
    voice: {
      label: 'NOW HER VOICE, TOO', titleA: 'Not just her face —', highlight: 'her voice too',
      sub: 'Now we clone her voice as well. Personalized audios for your fans — in her voice, in her language, with nothing for her to record.',
      badge: 'Her voice · Her language',
      cases: [
        { t: 'Welcome in her voice', d: 'Every new fan gets a welcome audio spoken in her own voice.' },
        { t: 'PPV audios', d: 'Paid voice messages, ready to sell right in the chat.' },
        { t: 'Personalized messages', d: 'Custom audios for her VIPs, with their name and in her language.' },
      ],
      note: 'Her voice, in her language, without recording every time.',
    },
    comparison: {
  ...
  // ════════════════════════════════════════════════════════════ PT
  pt: {
    nav: { creators: 'Criadores', agencies: 'Agências', pricing: 'Preços', results: 'Resultados', cta: 'Começar grátis', delivery: 'Como funciona', packages: 'Pacotes', howWeWork: 'Como trabalhamos' },
    hero: {
      eyebrow: 'PARA CRIADORAS DE ONLYFANS', eyebrowPre: 'Para criadoras de', eyebrowPost: '',
      pre: 'Clona a tua cara e a tua voz. Conteúdo que engaja e vende.',
      sub: 'Fotos, vídeos e áudios com a tua cara e a tua voz para engajar fãs, atrair tráfego e vender — sem produção.',
      highlight: 'a tua cara e a tua voz, engaja e vende, sem produção',
      platformsSellOn: 'Engaja no', platformsTrafficFrom: 'e traz tráfego de',
      ...
      ctaPrimary: 'Porque precisas disto?',
    ...
    voice: {
      label: 'AGORA TAMBÉM A VOZ', titleA: 'Não só o rosto dela —', highlight: 'também a voz',
      sub: 'Agora também clonamos a voz dela. Áudios personalizados para os seus fãs — com a voz dela, no idioma dela, sem precisar gravar nada.',
      badge: 'A voz dela · O idioma dela',
      cases: [
        { t: 'Boas-vindas com a voz dela', d: 'Cada novo fã recebe um áudio de boas-vindas falado com a própria voz dela.' },
        { t: 'Áudios PPV', d: 'Mensagens de voz pagas, prontas para vender no chat.' },
        { t: 'Mensagens personalizadas', d: 'Áudios sob medida para os VIPs dela, com o nome deles e no idioma dela.' },
      ],
      note: 'A voz dela, no idioma dela, sem gravar toda vez.',
    },
    comparison: {
      label: 'COMPARAÇÃO', titleA: 'Shoot tradicional vs', titleHighlight: 'LetShoot',
      sub: 'Tudo o que gastarias numa ÚNICA sessão de fotos, aqui tens todo mês — e apareces em qualquer lugar onde o teu público quer ver-te.',
      col1: 'Shoot tradicional', col2: 'LetShoot',
      rows: [
        { label: 'Fotógrafo', trad: '$500 - $800', ls: 'Incluído' },
        { label: 'Maquilhagem e cabelo', trad: '$100 - $250', ls: 'Incluído' },
        { label: 'Guarda-roupa e outfits', trad: '$100 - $300', ls: 'Incluído' },
        { label: 'Locação / Airbnb', trad: '$150 - $500', ls: 'Incluído' },
        { label: 'Assistente e equipa', trad: '$100 - $300', ls: 'Incluído' },
        { label: 'Transporte e comida', trad: '$50 - $150', ls: 'Incluído' },
        { label: 'O teu tempo', trad: '5 - 7 horas', ls: 'Minutos' },
        { label: 'Resultado', trad: '10-15 fotos, 1 vídeo', ls: 'Onde tu quiseres' },
      ],
      totalLabel: 'Total', totalTrad: '$1.100 - $2.600', totalLs: 'Desde $200/mês',
    },
    results: {
    ...
    finalCta: { titleA: 'Cria o teu banco de conteúdo de venda', highlight: 'hoje', body: 'Fotos e vídeos curados, prontos para vender em PPV, chats e pedidos personalizados — sem dia de produção. Volume para agência? Fala connosco.', cta: 'Começar' },
    footer: {
      tagline: 'O teu fotógrafo IA.', builtFor: 'Feito para criadoras de',
      cols: [
  ...
  // ════════════════════════════════════════════════════════════ FR
  fr: {
    nav: { creators: 'Créateurs', agencies: 'Agences', pricing: 'Tarifs', results: 'Résultats', cta: 'Commencer gratuitement', delivery: 'Comment ça marche', packages: 'Forfaits', howWeWork: 'Comment on travaille' },
    hero: {
      eyebrow: 'POUR LES CRÉATRICES ONLYFANS', eyebrowPre: 'Pour les créatrices', eyebrowPost: '',
      pre: 'Clone ton visage et ta voix. Du contenu qui accroche et vend.',
      sub: 'Photos, vidéos et audios avec ton visage et ta voix pour accrocher les fans, attirer du trafic et vendre — sans production.',
      highlight: 'ton visage et ta voix, accroche et vend, sans production',
      platformsSellOn: 'Engage sur', platformsTrafficFrom: 'et amène du trafic depuis',
      ...
      ctaPrimary: 'Pourquoi tu en as besoin ?',
    ...
    voice: {
      label: 'MAINTENANT SA VOIX AUSSI', titleA: 'Pas seulement son visage —', highlight: 'sa voix aussi',
      sub: 'Maintenant, on clone aussi sa voix. Des audios personnalisés pour tes fans — avec sa voix, dans sa langue, sans qu’elle ait à enregistrer quoi que ce soit.',
      badge: 'Sa voix · Sa langue',
      cases: [
        { t: 'Accueil avec sa voix', d: 'Chaque nouveau fan reçoit un audio de bienvenue dit avec sa propre voix.' },
        { t: 'Audios PPV', d: 'Des messages vocaux payants, prêts à vendre dans le chat.' },
        { t: 'Messages personnalisés', d: 'Des audios sur mesure pour ses VIP, avec leur prénom et dans sa langue.' },
      ],
      note: 'Sa voix, dans sa langue, sans réenregistrer à chaque fois.',
    },
    comparison: {
      label: 'COMPARAISON', titleA: 'Séance classique vs', titleHighlight: 'LetShoot',
      sub: 'Tout ce que tu dépenserais pour UNE seule séance photo, tu l’as chaque mois — et tu es présente partout où ton audience veut te voir.',
      col1: 'Séance classique', col2: 'LetShoot',
      rows: [
        { label: 'Photographe', trad: '$500 - $800', ls: 'Inclus' },
        { label: 'Maquillage et coiffure', trad: '$100 - $250', ls: 'Inclus' },
        { label: 'Garde-robe et tenues', trad: '$100 - $300', ls: 'Inclus' },
        { label: 'Lieu / Airbnb', trad: '$150 - $500', ls: 'Inclus' },
        { label: 'Assistant et équipe', trad: '$100 - $300', ls: 'Inclus' },
        { label: 'Transport et repas', trad: '$50 - $150', ls: 'Inclus' },
        { label: 'Ton temps', trad: '5 - 7 heures', ls: 'Minutes' },
        { label: 'Résultat', trad: '10-15 photos, 1 vidéo', ls: 'Où tu veux' },
      ],
      totalLabel: 'Total', totalTrad: '$1 100 - $2 600', totalLs: 'Dès $200/mois',
    },
    results: {
    ...
    finalCta: { titleA: 'Crée ta banque de contenu à vendre dès', highlight: 'aujourd’hui', body: 'Des photos et vidéos sélectionnées, prêtes à vendre en PPV, chats et demandes personnalisées — sans journée de production. Besoin d’un volume agence ? Contacte-nous.', cta: 'Commencer' },
    footer: {
      tagline: 'Ton photographe IA.', builtFor: 'Conçu pour les créatrices',
      cols: [
  ...
  // ════════════════════════════════════════════════════════════ DE
  de: {
    nav: { creators: 'Creator', agencies: 'Agenturen', pricing: 'Preise', results: 'Ergebnisse', cta: 'Kostenlos starten', delivery: 'So funktioniert’s', packages: 'Pakete', howWeWork: 'So arbeiten wir' },
    hero: {
      eyebrow: 'FÜR ONLYFANS-CREATORINNEN', eyebrowPre: 'Für Creatorinnen auf', eyebrowPost: '',
      pre: 'Klone dein Gesicht und deine Stimme. Content, der fesselt und verkauft.',
      sub: 'Fotos, Videos und Audios mit deinem Gesicht und deiner Stimme, um Fans zu fesseln, Traffic zu holen und zu verkaufen — ohne Produktion.',
      highlight: 'dein Gesicht und deine Stimme, fesselt und verkauft, ohne Produktion',
      platformsSellOn: 'Binde auf', platformsTrafficFrom: 'und hol Traffic von',
      ...
      ctaPrimary: 'Warum du das brauchst',
    ...
    voice: {
      label: 'JETZT AUCH IHRE STIMME', titleA: 'Nicht nur ihr Gesicht —', highlight: 'auch ihre Stimme',
      sub: 'Jetzt klonen wir auch ihre Stimme. Personalisierte Audios für deine Fans — mit ihrer Stimme, in ihrer Sprache, ganz ohne selbst aufzunehmen.',
      badge: 'Ihre Stimme · Ihre Sprache',
      cases: [
        { t: 'Begrüßung mit ihrer Stimme', d: 'Jeder neue Fan bekommt ein Willkommens-Audio in ihrer eigenen Stimme.' },
        { t: 'PPV-Audios', d: 'Bezahlte Sprachnachrichten, direkt im Chat verkaufsbereit.' },
        { t: 'Personalisierte Nachrichten', d: 'Maßgeschneiderte Audios für ihre VIPs, mit deren Namen und in ihrer Sprache.' },
      ],
      note: 'Ihre Stimme, in ihrer Sprache, ohne jedes Mal aufzunehmen.',
    },
    comparison: {
      label: 'VERGLEICH', titleA: 'Klassisches Shooting vs', titleHighlight: 'LetShoot',
      sub: 'Alles, was du für EIN einziges Fotoshooting ausgeben würdest, bekommst du jeden Monat — und du bist überall präsent, wo dein Publikum dich sehen will.',
      col1: 'Klassisches Shooting', col2: 'LetShoot',
      rows: [
        { label: 'Fotograf', trad: '$500 - $800', ls: 'Inklusive' },
        { label: 'Make-up & Haare', trad: '$100 - $250', ls: 'Inklusive' },
        { label: 'Garderobe & Outfits', trad: '$100 - $300', ls: 'Inklusive' },
        { label: 'Location / Airbnb', trad: '$150 - $500', ls: 'Inklusive' },
        { label: 'Assistenz & Crew', trad: '$100 - $300', ls: 'Inklusive' },
        { label: 'Transport & Verpflegung', trad: '$50 - $150', ls: 'Inklusive' },
        { label: 'Deine Zeit', trad: '5 - 7 Stunden', ls: 'Minuten' },
        { label: 'Ergebnis', trad: '10-15 Fotos, 1 Video', ls: 'Wo immer du willst' },
      ],
      totalLabel: 'Gesamt', totalTrad: '$1.100 - $2.600', totalLs: 'Ab $200/Monat',
    },
    results: {
    ...
    finalCta: { titleA: 'Erstelle deine Verkaufs-Content-Bank noch', highlight: 'heute', body: 'Kuratierte, verkaufsfertige Fotos und Videos für PPV, Chats und individuelle Wünsche — ganz ohne Produktionstag. Agentur-Volumen gebraucht? Schreib uns.', cta: 'Loslegen' },
    footer: {
      tagline: 'Dein KI-Fotograf.', builtFor: 'Gemacht für Creatorinnen auf',
      cols: [
  ...
  // ════════════════════════════════════════════════════════════ IT
  it: {
    nav: { creators: 'Creator', agencies: 'Agenzie', pricing: 'Prezzi', results: 'Risultati', cta: 'Inizia gratis', delivery: 'Come funziona', packages: 'Pacchetti', howWeWork: 'Come lavoriamo' },
    hero: {
      eyebrow: 'PER CREATOR DI ONLYFANS', eyebrowPre: 'Per creator di', eyebrowPost: '',
      pre: 'Clona il tuo viso e la tua voce. Contenuto che aggancia e vende.',
      sub: 'Foto, video e audio con il tuo viso e la tua voce per agganciare i fan, attirare traffico e vendere — senza produzione.',
      highlight: 'il tuo viso e la tua voce, aggancia e vende, senza produzione',
      platformsSellOn: 'Coinvolgi su', platformsTrafficFrom: 'e porta traffico da',
    ...
    voice: {
      label: 'ORA ANCHE LA VOCE', titleA: 'Non solo il suo viso —', highlight: 'anche la sua voce',
      sub: 'Ora cloniamo anche la sua voce. Audio personalizzati per i tuoi fan — con la sua voce, nella sua lingua, senza dover registrare nulla.',
      badge: 'La sua voce · La sua lingua',
      cases: [
        { t: 'Benvenuto con la sua voce', d: 'Ogni nuovo fan riceve un audio di benvenuto detto con la sua stessa voce.' },
        { t: 'Audio PPV', d: 'Messaggi vocali a pagamento, pronti da vendere in chat.' },
        { t: 'Messaggi personalizzati', d: 'Audio su misura per i suoi VIP, con il loro nome e nella sua lingua.' },
      ],
      note: 'La sua voce, nella sua lingua, senza registrare ogni volta.',
    },
    comparison: {
      label: 'CONFRONTO', titleA: 'Shooting tradizionale vs', titleHighlight: 'LetShoot',
      sub: 'Tutto quello che spenderesti per UN solo servizio fotografico, ce l’hai ogni mese — e appari ovunque il tuo pubblico voglia vederti.',
      col1: 'Shooting tradizionale', col2: 'LetShoot',
      rows: [
        { label: 'Fotografo', trad: '$500 - $800', ls: 'Incluso' },
        { label: 'Trucco e parrucco', trad: '$100 - $250', ls: 'Incluso' },
        { label: 'Guardaroba e outfit', trad: '$100 - $300', ls: 'Incluso' },
        { label: 'Location / Airbnb', trad: '$150 - $500', ls: 'Incluso' },
        { label: 'Assistente e crew', trad: '$100 - $300', ls: 'Incluso' },
        { label: 'Trasporti e pasti', trad: '$50 - $150', ls: 'Incluso' },
        { label: 'Il tuo tempo', trad: '5 - 7 ore', ls: 'Minuti' },
        { label: 'Risultato', trad: '10-15 foto, 1 video', ls: 'Dove vuoi tu' },
      ],
      totalLabel: 'Totale', totalTrad: '$1.100 - $2.600', totalLs: 'Da $200/mese',
    },
    results: {
    ...
    finalCta: { titleA: 'Crea la tua banca di contenuti da vendere', highlight: 'oggi', body: 'Foto e video curati, pronti da vendere in PPV, chat e richieste personalizzate — senza giornata di produzione. Volumi da agenzia? Scrivici.', cta: 'Inizia' },
    footer: {
      tagline: 'Il tuo fotografo IA.', builtFor: 'Creato per creator di',
      cols: [
  ...
  // ════════════════════════════════════════════════════════════ ZH
  zh: {
    nav: { creators: '创作者', agencies: '机构', pricing: '价格', results: '案例', cta: '免费开始', delivery: '如何运作', packages: '套餐', howWeWork: '我们如何合作' },
    hero: {
      eyebrow: '为 ONLYFANS 创作者打造', eyebrowPre: '为', eyebrowPost: '创作者',
      pre: '克隆你的面孔与声音。内容既圈粉又变现。',
      sub: '带着你面孔和声音的照片、视频和音频，圈粉引流、直接变现——无需拍摄制作。',
      highlight: '你的面孔与声音, 圈粉又变现, 无需制作',
      platformsSellOn: '在此互动', platformsTrafficFrom: '并从这里引流',
    ...
    voice: {
      label: '现在，还有声音', titleA: '不只是她的脸 ——', highlight: '还有她的声音',
      sub: '现在我们也克隆她的声音。为你的粉丝生成专属音频——用她的声音、她的语言，无需她每次亲自录制。',
      badge: '她的声音 · 她的语言',
      cases: [
        { t: '用她的声音欢迎', d: '每位新粉丝都会收到一段用她本人声音录制的欢迎音频。' },
        { t: 'PPV 音频', d: '付费语音消息，随时在聊天里售卖。' },
        { t: '定制消息', d: '为她的 VIP 量身定制的音频，带上他们的名字，用她的语言。' },
      ],
      note: '她的声音，她的语言，无需每次录制。',
    },
    comparison: {
      label: '对比', titleA: '传统拍摄 vs', titleHighlight: 'LetShoot',
      sub: '你花在一次拍摄上的全部预算，这里每个月都给你——而且你能出现在受众想看到你的任何地方。',
      col1: '传统拍摄', col2: 'LetShoot',
      rows: [
        { label: '摄影师', trad: '$500 - $800', ls: '已包含' },
        { label: '化妆和发型', trad: '$100 - $250', ls: '已包含' },
        { label: '服装和造型', trad: '$100 - $300', ls: '已包含' },
        { label: '场地 / Airbnb', trad: '$150 - $500', ls: '已包含' },
        { label: '助理和团队', trad: '$100 - $300', ls: '已包含' },
        { label: '交通和餐饮', trad: '$50 - $150', ls: '已包含' },
        { label: '你的时间', trad: '5 - 7 小时', ls: '几分钟' },
        { label: '成果', trad: '10-15 张照片, 1 个视频', ls: '想在哪就在哪' },
      ],
      totalLabel: '合计', totalTrad: '$1,100 - $2,600', totalLs: '$200/月起',
    },
    results: {
    ...
    finalCta: { titleA: '今天就打造你的', highlight: '变现内容库', body: '精选、可直接售卖的照片和视频，适用于 PPV、聊天和定制需求——无需拍摄日。需要机构级产量？联系我们。', cta: '立即开始' },
    footer: {
      tagline: '你的 AI 摄影师。', builtFor: '为以下平台的创作者打造',
      cols: [
