...
export const dict = {
  ...
  es: {
    ...
    hero: {
      eyebrow: 'PARA CREADORAS DE ONLYFANS',
      pre: 'Dile adiós a tu',
      highlight: 'fotógrafo',
      body: 'Nosotros creamos las fotos y videos que vende tu OnlyFans — sin fotógrafo, sin estudio, sin maquillista, sin Uber. Tú solo apruebas y publicas.',
    ...
    finalCta: { titleA: 'Dile adiós a tu fotógrafo', highlight: 'hoy', body: 'Nosotros creamos el contenido que vende tu OnlyFans — fotos y videos listos para publicar, sin fotógrafo ni estudio. Tú solo apruebas.', cta: 'Empezar ahora' },
    footer: {
  ...
  en: {
    ...
    hero: {
      eyebrow: 'FOR ONLYFANS CREATORS',
      pre: 'Say goodbye to your',
      highlight: 'photographer',
      body: 'We create the photos and videos your OnlyFans sells — no photographer, no studio, no makeup artist, no Uber. You just approve and post.',
    ...
    finalCta: { titleA: 'Say goodbye to your photographer', highlight: 'today', body: 'We create the content your OnlyFans sells — photos and videos ready to post, no photographer or studio. You just approve.', cta: 'Start now' },
    footer: {
