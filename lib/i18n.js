...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      pre: 'No dejes que la falta de contenido te cueste dinero',
      sub: 'Responde al instante con el contenido ideal para cada situación.',
      highlight: 'contenido inmediato, en el momento indicado, listo para vender',
    ...
    results: {
      ...
      cards: [
        ...
        { t: 'En casa', loc: 'Sofá · luz cálida', hue: 'accent' },
        { t: 'Cocina', loc: 'Desayuno · luz natural', hue: 'violet' },
        { t: 'Él también', loc: 'Casa · día normal', hue: 'coral' },
      ],
    },
    pricing: {
  ...
  en: {
    ...
    hero: {
      ...
      pre: 'Don’t let missing content cost you money',
      sub: 'Respond instantly with the perfect content for every situation.',
      highlight: 'instant content, right on time, ready to sell',
    ...
    results: {
      ...
      cards: [
        ...
        { t: 'At home', loc: 'Couch · warm light', hue: 'accent' },
        { t: 'Kitchen', loc: 'Breakfast · daylight', hue: 'violet' },
        { t: 'Him too', loc: 'Home · everyday', hue: 'coral' },
      ],
    },
    pricing: {
  ...
  pt: {
    ...
    hero: {
      ...
      pre: 'Não deixes que a falta de conteúdo te custe dinheiro',
      sub: 'Responde na hora com o conteúdo ideal para cada situação.',
      highlight: 'conteúdo imediato, na hora certa, pronto para vender',
      platformsLabel: 'Pronto para vender em',
    ...
    results: {
      ...
      cards: [
        ...
        { t: 'Em casa', loc: 'Sofá · luz quente', hue: 'accent' },
        { t: 'Cozinha', loc: 'Café da manhã · luz natural', hue: 'violet' },
        { t: 'Ele também', loc: 'Casa · dia comum', hue: 'coral' },
      ],
    },
    pricing: {
  ...
  fr: {
    ...
    hero: {
      ...
      pre: 'Ne laisse pas le manque de contenu te coûter de l’argent',
      sub: 'Réponds instantanément avec le contenu idéal pour chaque situation.',
      highlight: 'contenu immédiat, au bon moment, prêt à vendre',
      platformsLabel: 'Prêt à vendre sur',
    ...
    results: {
      ...
      cards: [
        ...
        { t: 'À la maison', loc: 'Canapé · lumière chaude', hue: 'accent' },
        { t: 'Cuisine', loc: 'Petit-déj · lumière du jour', hue: 'violet' },
        { t: 'Lui aussi', loc: 'Maison · quotidien', hue: 'coral' },
      ],
    },
    pricing: {
  ...
  de: {
    ...
    hero: {
      ...
      pre: 'Lass fehlenden Content dich kein Geld kosten',
      sub: 'Reagiere sofort mit dem perfekten Content für jede Situation.',
      highlight: 'sofortiger Content, im richtigen Moment, verkaufsbereit',
      platformsLabel: 'Bereit zum Verkauf auf',
    ...
    results: {
      ...
      cards: [
        ...
        { t: 'Zuhause', loc: 'Sofa · warmes Licht', hue: 'accent' },
        { t: 'Küche', loc: 'Frühstück · Tageslicht', hue: 'violet' },
        { t: 'Er auch', loc: 'Zuhause · Alltag', hue: 'coral' },
      ],
    },
    pricing: {
  ...
  it: {
    ...
    hero: {
      ...
      pre: 'Non lasciare che la mancanza di contenuti ti costi denaro',
      sub: 'Rispondi all’istante con il contenuto perfetto per ogni situazione.',
      highlight: 'contenuto immediato, al momento giusto, pronto da vendere',
      platformsLabel: 'Pronto per vendere su',
    ...
    results: {
      ...
      cards: [
        ...
        { t: 'A casa', loc: 'Divano · luce calda', hue: 'accent' },
        { t: 'Cucina', loc: 'Colazione · luce naturale', hue: 'violet' },
        { t: 'Anche lui', loc: 'Casa · quotidiano', hue: 'coral' },
      ],
    },
    pricing: {
  ...
  zh: {
    ...
    hero: {
      ...
      pre: '别让内容的缺失让你损失收入',
      sub: '在每个情境下都能即刻用最合适的内容回应。',
      highlight: '即时内容, 恰逢其时, 即可变现',
      platformsLabel: '随时可在以下平台变现',
    ...
    results: {
      ...
      cards: [
        ...
        { t: '在家', loc: '沙发 · 暖光', hue: 'accent' },
        { t: '厨房', loc: '早餐 · 自然光', hue: 'violet' },
        { t: '他也可以', loc: '居家 · 日常', hue: 'coral' },
      ],
    },
    pricing: {
