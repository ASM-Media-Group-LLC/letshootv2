...
export const dict = {
  ...
  es: {
    ...
    hero: {
      eyebrow: 'PARA CREADORAS QUE YA VENDEN SU CONTENIDO',
      pre: 'Dile adiós a tu',
      highlight: 'fotógrafo',
      body: 'Tú ya vendes tu contenido. Nosotros te creamos todas las fotos y videos que venden — sin fotógrafo, sin estudio, sin esperas. Tú solo apruebas y publicas.',
      ctaPrimary: 'Crear mi contenido',
    ...
    pricing: {
      ...
      sub: 'Elige tu plan y empieza a producir hoy mismo. Cancela cuando quieras.',
    ...
    finalCta: { titleA: 'Dile adiós a tu fotógrafo', highlight: 'hoy', body: 'Nosotros creamos todo tu contenido que vende — fotos y videos listos para publicar. Tú solo apruebas.', cta: 'Empezar ahora' },
    footer: {
  ...
  en: {
    ...
    hero: {
      eyebrow: 'FOR CREATORS WHO ALREADY SELL THEIR CONTENT',
      pre: 'Say goodbye to your',
      highlight: 'photographer',
      body: 'You already sell your content. We create all the photos and videos that sell for you — no photographer, no studio, no waiting. You just approve and post.',
      ctaPrimary: 'Create my content',
    ...
    pricing: {
      ...
      sub: 'Pick your plan and start producing today. Cancel anytime.',
    ...
    finalCta: { titleA: 'Say goodbye to your photographer', highlight: 'today', body: 'We create all your content that sells — photos and videos ready to post. You just approve.', cta: 'Start now' },
    footer: {
