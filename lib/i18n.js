...
export const dict = {
  ...
  es: {
    ...
    hero: {
      ...
      platformsSellOn: 'Vende y engancha en', platformsTrafficFrom: 'y trae tráfico desde',
  ...
  en: {
    ...
    hero: {
      ...
      platformsSellOn: 'Sell & engage on', platformsTrafficFrom: 'and drive traffic from',
  ...
  pt: {
    ...
    hero: {
      ...
      platformsSellOn: 'Vende e engaja no', platformsTrafficFrom: 'e traz tráfego de',
  ...
  fr: {
    ...
    hero: {
      ...
      platformsSellOn: 'Vends et engage sur', platformsTrafficFrom: 'et amène du trafic depuis',
  ...
  de: {
    ...
    hero: {
      ...
      platformsSellOn: 'Verkaufe & binde auf', platformsTrafficFrom: 'und hol Traffic von',
  ...
  it: {
    ...
    hero: {
      ...
      platformsSellOn: 'Vendi e coinvolgi su', platformsTrafficFrom: 'e porta traffico da',
  ...
  zh: {
    ...
    hero: {
      ...
      platformsSellOn: '在此变现与互动', platformsTrafficFrom: '并从这里引流',
