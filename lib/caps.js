...
export const CAP_SECTIONS = [
  {
    ...
    caps: [
      ...
      { v: 'add_creators', l: 'Dar de alta creadoras', hint: 'Crear cuentas de creadora nuevas (envía invitación)' },
    ],
  },
  {
  ...
  },
  {
    ...
    caps: [
      { v: 'proposals', l: 'Crear propuestas', hint: 'Armar y publicar propuestas de fotos para prospectos y clientas' },
    ],
  },
  {
    id: 'agencias', name: 'Agencias',
    caps: [
      { v: 'agencies', l: 'Gestionar agencias', hint: 'Crear agencias y vincularles sus modelos' },
    ],
  },
  {
    ...
    caps: [
      ...
      { v: 'billing', l: 'Suscripciones y cobros', hint: 'Activar planes, cortesías y fechas de vencimiento' },
    ],
  },
  {
    id: 'equipo', name: 'Equipo',
    caps: [
      { v: 'team', l: 'Gestionar equipo', hint: 'Crear puestos de empleado y dar accesos' },
    ],
  },
];
