...
// preferJpeg: fuerza salida JPEG alta calidad (formato universal — p.ej. fotos
// de entrenamiento LoRA, donde no queremos arriesgar compatibilidad con WebP).
export function cleanImageToWebp(file, { maxDim = 2560, quality = 0.95, preferJpeg = false } = {}) {
