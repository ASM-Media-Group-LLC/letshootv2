...
export const CLONE_EXAMPLES = {
  ...
  // Real 90° side profiles generated with the Julia Parker character in
  // Higgsfield Soul (2026-07-28) + the 2 best side-angled catalog shots.
  right: [
    'julia-perfil-1', 'julia-perfil-2', 'julia-perfil-3', 'julia-perfil-4',
    'julia-perfil-5', 'julia-perfil-6', 'gimnasio-post-entreno', 'yoga-ropa',
  ],
  expression: [
...
// Tattoos & marks — 10 real close-up examples (Julia's ribcage tulip crop +
...
export const MARKS_EXAMPLES = [
  ...
  'julia-marca-6', 'julia-marca-7', 'julia-marca-8', 'julia-marca-9', 'julia-marca-10',
];
export const MARKS_REC = 10;
