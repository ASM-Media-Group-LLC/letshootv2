...
export const CLONE_EXAMPLES = {
  front: [
    ...
    'julia-frontal-1', 'moto-carretera', 'tudecides-rueda', 'comida-desayuno',
  ...
  right: [
    'julia-perfil-1', 'julia-perfil-9', 'julia-perfil-3', 'julia-perfil-4',
    'julia-perfil-5', 'julia-perfil-6', 'julia-perfil-7', 'julia-perfil-8',
  ],
  expression: [
    'emociones-emocionada', 'emociones-feliz', 'regalos-abriendo', 'julia-risa-1',
  ...
  half: [
    ...
    'compras-super', 'moto-enlamoto', 'lujo-hotel', 'julia-medio-1',
  ...
  bikini: ['julia-bikini-7', 'julia-bikini-8', 'julia-bikini-9', 'julia-bikini-3', 'compras-lenceria', 'resort-cabana'],
...
export const MARKS_EXAMPLES = [
  ...
  'julia-marca-6', 'julia-marca-8', 'julia-marca-9', 'julia-marca-11',
];
