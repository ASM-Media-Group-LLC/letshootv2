...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'Briefcase', name: 'Trabajo', scenes: ['Contestando mensajes', 'Grabando contenido', 'Sesión de fotos', 'Planeando la semana'], imgs: ['/lib/trabajo-mensajes.jpg', '/lib/trabajo-grabando.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'Briefcase', name: 'Work', scenes: ['Answering messages', 'Filming content', 'At a photo shoot', 'Planning the week'], imgs: ['/lib/trabajo-mensajes.jpg', '/lib/trabajo-grabando.jpg', null, null] },
