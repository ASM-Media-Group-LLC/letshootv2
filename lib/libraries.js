...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'PartyPopper', name: 'Hitos contigo', scenes: ['1 mes juntos', 'Aniversario de suscripción', 'Gracias por estar', 'Nuestro recuerdo'], imgs: ['/lib/hitos-1mes.jpg', '/lib/hitos-aniversario.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'PartyPopper', name: 'Milestones with you', scenes: ['1 month together', 'Subscription anniversary', 'Thanks for being here', 'Our memory'], imgs: ['/lib/hitos-1mes.jpg', '/lib/hitos-aniversario.jpg', null, null] },
