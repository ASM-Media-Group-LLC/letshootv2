...
// Translations for pt/fr/de/it/zh live in sibling files and are merged below.

import { GROUPS_PT, LIBRARIES_PT, AUDIO_PT } from './libraries.pt';
import { GROUPS_FR, LIBRARIES_FR, AUDIO_FR } from './libraries.fr';
import { GROUPS_DE, LIBRARIES_DE, AUDIO_DE } from './libraries.de';
import { GROUPS_IT, LIBRARIES_IT, AUDIO_IT } from './libraries.it';
import { GROUPS_ZH, LIBRARIES_ZH, AUDIO_ZH } from './libraries.zh';

export const GROUPS = {
  pt: GROUPS_PT, fr: GROUPS_FR, de: GROUPS_DE, it: GROUPS_IT, zh: GROUPS_ZH,
  es: [
...
export const LIBRARIES = {
  pt: LIBRARIES_PT, fr: LIBRARIES_FR, de: LIBRARIES_DE, it: LIBRARIES_IT, zh: LIBRARIES_ZH,
  es: [
    // ── Tu día a día ──
    ...
    { g: 'fantasia', icon: 'Gamepad2', name: 'Gamer', scenes: ['Jugando de noche', 'Setup gamer', 'Perdí la apuesta', 'Jugamos juntos'], imgs: ['/lib/gamer-noche.jpg', '/lib/gamer-setup.jpg', '/lib/gamer-apuesta.jpg', '/lib/gamer-juntos.jpg'] },
    { g: 'fantasia', icon: 'GraduationCap', name: 'Universidad', scenes: ['Estudiando tarde', 'Uniforme', 'En la biblioteca', 'Examen aprobado'], imgs: ['/lib/universidad-estudiando.jpg', '/lib/universidad-uniforme.jpg', '/lib/universidad-biblioteca.jpg', '/lib/universidad-examen.jpg'] },
    { g: 'fantasia', icon: 'Route', name: 'Moto & aventura', scenes: ['En la moto', 'Casco y cuero', 'Carretera abierta', 'Escapada'], imgs: ['/lib/moto-enlamoto.jpg', '/lib/moto-casco.jpg', '/lib/moto-carretera.jpg', '/lib/moto-escapada.jpg'] },
    { g: 'fantasia', icon: 'Dices', name: 'Tú decides', scenes: ['Elige mi outfit', 'Verdad o reto', 'Rueda de la suerte', 'Tú mandas hoy'], imgs: ['/lib/tudecides-outfit.jpg', '/lib/tudecides-verdad.jpg', '/lib/tudecides-rueda.jpg', '/lib/tudecides-mandas.jpg'] },
    { g: 'fantasia', icon: 'Target', name: 'Pedidos personalizados', scenes: ['Tu pedido especial', 'Hecho solo para ti', 'Lo que me pediste', 'Custom exclusivo'], imgs: ['/lib/pedidos-especial.jpg', '/lib/pedidos-parati.jpg', '/lib/pedidos-loquepediste.jpg', '/lib/pedidos-custom.jpg'] },
    { g: 'fantasia', icon: 'Music', name: 'Música & baile', scenes: ['Cantando en el carro', 'Bailando en casa', 'Con audífonos', 'Playlist para ti'], imgs: ['/lib/musica-carro.jpg', '/lib/musica-baile.jpg', '/lib/musica-audifonos.jpg', '/lib/musica-playlist.jpg'] },

    // ── Venta & urgencia ──
    { g: 'venta', icon: 'Timer', name: 'Ofertas y urgencia', scenes: ['Drop de medianoche', 'Solo por hoy', 'Últimas horas', 'Descuento sorpresa'], imgs: ['/lib/venta-drop-medianoche.jpg', '/lib/venta-solo-hoy.jpg', '/lib/venta-ultimas-horas.jpg', '/lib/venta-descuento-sorpresa.jpg'] },
    { g: 'venta', icon: 'Lock', name: 'Solo para ti (VIP)', scenes: ['Esto no va a mi feed', 'Un secreto entre los dos', 'Regalo personalizado', 'Tu nombre en mi piel'], imgs: ['/lib/venta-nofeed.jpg', '/lib/venta-secreto.jpg', '/lib/venta-regalo.jpg', '/lib/venta-nombre-piel.jpg'] },
    { g: 'venta', icon: 'Trophy', name: 'Metas & retos', scenes: ['Meta de tips', 'Reto de la semana', 'Si llegamos a…', 'Recompensa desbloqueada'], imgs: ['/lib/venta-meta-tips.jpg', '/lib/venta-reto-semana.jpg', '/lib/venta-si-llegamos.jpg', '/lib/venta-recompensa.jpg'] },
    { g: 'venta', icon: 'Flame', name: 'Provocación', scenes: ['Nueva lencería', '¿Adivina qué llevo?', 'Cambio de outfit', 'Debajo del vestido'], imgs: ['/lib/venta-nueva-lenceria.jpg', '/lib/venta-adivina.jpg', '/lib/venta-cambio-outfit.jpg', '/lib/venta-debajo-vestido.jpg'] },
    { g: 'venta', icon: 'Package', name: 'Packs & bundles', scenes: ['Pack del mes', 'Combo especial', 'Colección completa', 'Lo más pedido'], imgs: ['/lib/venta-pack-mes.jpg', '/lib/venta-combo.jpg', '/lib/venta-coleccion.jpg', '/lib/venta-mas-pedido.jpg'] },
    { g: 'venta', icon: 'BellRing', name: 'Reactivación', scenes: ['Te fuiste sin despedirte', 'Volviste, te extrañé', 'Oferta de regreso', '¿Sigues ahí?'], imgs: ['/lib/venta-fuiste.jpg', '/lib/venta-volviste.jpg', '/lib/venta-oferta-regreso.jpg', '/lib/venta-sigues-ahi.jpg'] },
    { g: 'venta', icon: 'Eye', name: 'Adelantos', scenes: ['Sneak peek', 'Solo un pedacito', 'Lo que viene', 'Censurado por ahora'], imgs: ['/lib/venta-sneak-peek.jpg', '/lib/venta-pedacito.jpg', '/lib/venta-loquevendra.jpg', '/lib/venta-censurado.jpg'] },
    { g: 'venta', icon: 'BarChart3', name: 'Encuestas', scenes: ['¿Cuál prefieres?', 'Vota el próximo set', 'A o B', 'Encuesta picante'], imgs: ['/lib/venta-cual-prefieres.jpg', '/lib/venta-vota-set.jpg', '/lib/venta-ab.jpg', '/lib/venta-encuesta-picante.jpg'] },
    { g: 'venta', icon: 'MessageCircle', name: 'Openers de chat', scenes: ['Rompiendo el hielo', 'Te tengo algo', '¿Adivina qué hice hoy?', 'Pensé en ti'], imgs: ['/lib/venta-hielo.jpg', '/lib/venta-tengo-algo.jpg', '/lib/venta-adivina-hoy.jpg', '/lib/venta-pense-en-ti.jpg'] },
    { g: 'venta', icon: 'Ticket', name: 'Acceso limitado', scenes: ['Solo 10 personas', 'Invitación privada', 'Lista VIP', 'Se borra en 24 h'], imgs: ['/lib/venta-solo10.jpg', '/lib/venta-invitacion.jpg', '/lib/venta-vip.jpg', '/lib/venta-borra24h.jpg'] },

    // ── Lifestyle premium ──
    { g: 'premium', icon: 'Plane', name: 'Viajes', scenes: ['Camino al aeropuerto', 'En el avión', 'Llegando al hotel', 'Conociendo la ciudad'], imgs: ['/lib/viajes-aeropuerto.jpg', '/lib/viajes-avion.jpg', '/lib/viajes-hotel.jpg', '/lib/viajes-ciudad.jpg'] },
    { g: 'premium', icon: 'Hotel', name: 'Resort & vacaciones', scenes: ['Check-in en el resort', 'Cabaña frente al mar', 'Atardecer en la playa', 'Piña colada'], imgs: ['/lib/resort-checkin.jpg', '/lib/resort-cabana.jpg', '/lib/resort-atardecer.jpg', '/lib/resort-pinacolada.jpg'] },
    { g: 'premium', icon: 'Sun', name: 'Playa & piscina', scenes: ['Día de piscina', 'Día de playa', 'Bronceándome', 'Mojada del mar'], imgs: ['/lib/playa-piscina.jpg', '/lib/playa-playa.jpg', '/lib/playa-bronceando.jpg', '/lib/playa-mojada.jpg'] },
    { g: 'premium', icon: 'Bath', name: 'Jacuzzi & spa', scenes: ['Jacuzzi de noche', 'Sauna privada', 'Baño de burbujas', 'Día de spa'], imgs: ['/lib/spa-jacuzzi-noche.jpg', '/lib/spa-sauna-privada.jpg', '/lib/spa-burbujas.jpg', '/lib/spa-dia.jpg'] },
    { g: 'premium', icon: 'Droplets', name: 'Ducha', scenes: ['Antes de la ducha', 'Vapor en el espejo', 'Solo una toalla', 'Pelo mojado'], imgs: ['/lib/ducha-antes.jpg', '/lib/ducha-vapor.jpg', '/lib/ducha-toalla.jpg', '/lib/ducha-pelo.jpg'] },
    { g: 'premium', icon: 'Gem', name: 'Lujo', scenes: ['Hotel de lujo', 'Joyas', 'Auto deportivo', 'Champaña'], imgs: ['/lib/lujo-hotel.jpg', '/lib/lujo-joyas.jpg', '/lib/lujo-auto.jpg', '/lib/lujo-champana.jpg'] },
    { g: 'premium', icon: 'Building2', name: 'Ciudad de noche', scenes: ['Luces de la ciudad', 'Rooftop', 'Taxi nocturno', 'Vitrinas de noche'], imgs: ['/lib/ciudad-luces.jpg', '/lib/ciudad-rooftop.jpg', '/lib/ciudad-taxi.jpg', '/lib/ciudad-vitrinas.jpg'] },
    { g: 'premium', icon: 'Martini', name: 'Bar & cocteles', scenes: ['Cóctel en la barra', 'Brindis', 'Noche de bar', 'Vino en casa'], imgs: ['/lib/bar-coctel.jpg', '/lib/bar-brindis.jpg', '/lib/bar-noche.jpg', '/lib/bar-vino.jpg'] },
    { g: 'premium', icon: 'Users', name: 'Vida social', scenes: ['Antes de salir', 'En una fiesta', 'Después de la fiesta', 'Con amigas'], imgs: ['/lib/social-antes.jpg', '/lib/social-fiesta.jpg', '/lib/social-despues.jpg', '/lib/social-amigas.jpg'] },
    { g: 'premium', icon: 'Flower2', name: 'Yoga & wellness', scenes: ['Clase de yoga', 'Estirando en casa', 'Meditando', 'Ropa deportiva nueva'], imgs: ['/lib/yoga-clase.jpg', '/lib/yoga-estirando.jpg', '/lib/yoga-meditando.jpg', '/lib/yoga-ropa.jpg'] },
  ],
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Gamepad2', name: 'Gamer', scenes: ['Playing at night', 'Gamer setup', 'I lost the bet', 'Playing together'], imgs: ['/lib/gamer-noche.jpg', '/lib/gamer-setup.jpg', '/lib/gamer-apuesta.jpg', '/lib/gamer-juntos.jpg'] },
    { g: 'fantasia', icon: 'GraduationCap', name: 'College', scenes: ['Studying late', 'Uniform', 'At the library', 'Passed the exam'], imgs: ['/lib/universidad-estudiando.jpg', '/lib/universidad-uniforme.jpg', '/lib/universidad-biblioteca.jpg', '/lib/universidad-examen.jpg'] },
    { g: 'fantasia', icon: 'Route', name: 'Bike & adventure', scenes: ['On the bike', 'Helmet and leather', 'Open road', 'Getaway'], imgs: ['/lib/moto-enlamoto.jpg', '/lib/moto-casco.jpg', '/lib/moto-carretera.jpg', '/lib/moto-escapada.jpg'] },
    { g: 'fantasia', icon: 'Dices', name: 'You decide', scenes: ['Pick my outfit', 'Truth or dare', 'Spin the wheel', 'You’re in charge today'], imgs: ['/lib/tudecides-outfit.jpg', '/lib/tudecides-verdad.jpg', '/lib/tudecides-rueda.jpg', '/lib/tudecides-mandas.jpg'] },
    { g: 'fantasia', icon: 'Target', name: 'Custom requests', scenes: ['Your special request', 'Made just for you', 'What you asked for', 'Exclusive custom'], imgs: ['/lib/pedidos-especial.jpg', '/lib/pedidos-parati.jpg', '/lib/pedidos-loquepediste.jpg', '/lib/pedidos-custom.jpg'] },
    { g: 'fantasia', icon: 'Music', name: 'Music & dancing', scenes: ['Singing in the car', 'Dancing at home', 'With headphones', 'Playlist for you'], imgs: ['/lib/musica-carro.jpg', '/lib/musica-baile.jpg', '/lib/musica-audifonos.jpg', '/lib/musica-playlist.jpg'] },

    // ── Sales & urgency ──
    { g: 'venta', icon: 'Timer', name: 'Offers & urgency', scenes: ['Midnight drop', 'Today only', 'Final hours', 'Surprise discount'], imgs: ['/lib/venta-drop-medianoche.jpg', '/lib/venta-solo-hoy.jpg', '/lib/venta-ultimas-horas.jpg', '/lib/venta-descuento-sorpresa.jpg'] },
    { g: 'venta', icon: 'Lock', name: 'Just for you (VIP)', scenes: ['Not on my feed', 'A secret between us', 'Personalized gift', 'Your name on my skin'], imgs: ['/lib/venta-nofeed.jpg', '/lib/venta-secreto.jpg', '/lib/venta-regalo.jpg', '/lib/venta-nombre-piel.jpg'] },
    { g: 'venta', icon: 'Trophy', name: 'Goals & challenges', scenes: ['Tip goal', 'Challenge of the week', 'If we hit…', 'Reward unlocked'], imgs: ['/lib/venta-meta-tips.jpg', '/lib/venta-reto-semana.jpg', '/lib/venta-si-llegamos.jpg', '/lib/venta-recompensa.jpg'] },
    { g: 'venta', icon: 'Flame', name: 'Teasing', scenes: ['New lingerie', 'Guess what I’m wearing', 'Outfit change', 'Under the dress'], imgs: ['/lib/venta-nueva-lenceria.jpg', '/lib/venta-adivina.jpg', '/lib/venta-cambio-outfit.jpg', '/lib/venta-debajo-vestido.jpg'] },
    { g: 'venta', icon: 'Package', name: 'Packs & bundles', scenes: ['Pack of the month', 'Special combo', 'Full collection', 'Most requested'], imgs: ['/lib/venta-pack-mes.jpg', '/lib/venta-combo.jpg', '/lib/venta-coleccion.jpg', '/lib/venta-mas-pedido.jpg'] },
    { g: 'venta', icon: 'BellRing', name: 'Win-back', scenes: ['You left without saying bye', 'You’re back, I missed you', 'Welcome-back offer', 'Still there?'], imgs: ['/lib/venta-fuiste.jpg', '/lib/venta-volviste.jpg', '/lib/venta-oferta-regreso.jpg', '/lib/venta-sigues-ahi.jpg'] },
    { g: 'venta', icon: 'Eye', name: 'Previews', scenes: ['Sneak peek', 'Just a little piece', 'What’s coming', 'Censored for now'], imgs: ['/lib/venta-sneak-peek.jpg', '/lib/venta-pedacito.jpg', '/lib/venta-loquevendra.jpg', '/lib/venta-censurado.jpg'] },
    { g: 'venta', icon: 'BarChart3', name: 'Polls', scenes: ['Which one do you prefer?', 'Vote the next set', 'A or B', 'Spicy poll'], imgs: ['/lib/venta-cual-prefieres.jpg', '/lib/venta-vota-set.jpg', '/lib/venta-ab.jpg', '/lib/venta-encuesta-picante.jpg'] },
    { g: 'venta', icon: 'MessageCircle', name: 'Chat openers', scenes: ['Breaking the ice', 'I’ve got something for you', 'Guess what I did today', 'Thought of you'], imgs: ['/lib/venta-hielo.jpg', '/lib/venta-tengo-algo.jpg', '/lib/venta-adivina-hoy.jpg', '/lib/venta-pense-en-ti.jpg'] },
    { g: 'venta', icon: 'Ticket', name: 'Limited access', scenes: ['Only 10 people', 'Private invite', 'VIP list', 'Deletes in 24h'], imgs: ['/lib/venta-solo10.jpg', '/lib/venta-invitacion.jpg', '/lib/venta-vip.jpg', '/lib/venta-borra24h.jpg'] },

    // ── Premium lifestyle ──
    { g: 'premium', icon: 'Plane', name: 'Travel', scenes: ['On my way to the airport', 'On the plane', 'Arriving at the hotel', 'Exploring the city'], imgs: ['/lib/viajes-aeropuerto.jpg', '/lib/viajes-avion.jpg', '/lib/viajes-hotel.jpg', '/lib/viajes-ciudad.jpg'] },
    { g: 'premium', icon: 'Hotel', name: 'Resort & vacation', scenes: ['Resort check-in', 'Beachfront cabin', 'Sunset on the beach', 'Piña colada'], imgs: ['/lib/resort-checkin.jpg', '/lib/resort-cabana.jpg', '/lib/resort-atardecer.jpg', '/lib/resort-pinacolada.jpg'] },
    { g: 'premium', icon: 'Sun', name: 'Beach & pool', scenes: ['Pool day', 'Beach day', 'Tanning', 'Wet from the sea'], imgs: ['/lib/playa-piscina.jpg', '/lib/playa-playa.jpg', '/lib/playa-bronceando.jpg', '/lib/playa-mojada.jpg'] },
    { g: 'premium', icon: 'Bath', name: 'Jacuzzi & spa', scenes: ['Jacuzzi at night', 'Private sauna', 'Bubble bath', 'Spa day'], imgs: ['/lib/spa-jacuzzi-noche.jpg', '/lib/spa-sauna-privada.jpg', '/lib/spa-burbujas.jpg', '/lib/spa-dia.jpg'] },
    { g: 'premium', icon: 'Droplets', name: 'Shower', scenes: ['Before the shower', 'Steam on the mirror', 'Just a towel', 'Wet hair'], imgs: ['/lib/ducha-antes.jpg', '/lib/ducha-vapor.jpg', '/lib/ducha-toalla.jpg', '/lib/ducha-pelo.jpg'] },
    { g: 'premium', icon: 'Gem', name: 'Luxury', scenes: ['Luxury hotel', 'Jewelry', 'Sports car', 'Champagne'], imgs: ['/lib/lujo-hotel.jpg', '/lib/lujo-joyas.jpg', '/lib/lujo-auto.jpg', '/lib/lujo-champana.jpg'] },
    { g: 'premium', icon: 'Building2', name: 'City at night', scenes: ['City lights', 'Rooftop', 'Night taxi', 'Window shopping at night'], imgs: ['/lib/ciudad-luces.jpg', '/lib/ciudad-rooftop.jpg', '/lib/ciudad-taxi.jpg', '/lib/ciudad-vitrinas.jpg'] },
    { g: 'premium', icon: 'Martini', name: 'Bar & cocktails', scenes: ['Cocktail at the bar', 'A toast', 'Bar night', 'Wine at home'], imgs: ['/lib/bar-coctel.jpg', '/lib/bar-brindis.jpg', '/lib/bar-noche.jpg', '/lib/bar-vino.jpg'] },
    { g: 'premium', icon: 'Users', name: 'Social life', scenes: ['Before going out', 'At a party', 'After the party', 'With my girls'], imgs: ['/lib/social-antes.jpg', '/lib/social-fiesta.jpg', '/lib/social-despues.jpg', '/lib/social-amigas.jpg'] },
    { g: 'premium', icon: 'Flower2', name: 'Yoga & wellness', scenes: ['Yoga class', 'Stretching at home', 'Meditating', 'New workout set'], imgs: ['/lib/yoga-clase.jpg', '/lib/yoga-estirando.jpg', '/lib/yoga-meditando.jpg', '/lib/yoga-ropa.jpg'] },
  ],
};

// ── Audio: not offered yet. Kept apart, clearly marked as coming soon. ──
export const AUDIO = {
  pt: AUDIO_PT, fr: AUDIO_FR, de: AUDIO_DE, it: AUDIO_IT, zh: AUDIO_ZH,
  es: {
    title: 'Audio',
    badge: 'Próximamente',
