...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'Smile', name: 'Emociones', scenes: ['Hoy estoy feliz', 'Tuve un día difícil', 'Me siento sola', 'Estoy emocionada por algo'], imgs: ['/lib/emociones-feliz.jpg', '/lib/emociones-dificil.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'Smile', name: 'Emotions', scenes: ['Feeling happy today', 'Had a rough day', 'Feeling lonely', 'Excited about something'], imgs: ['/lib/emociones-feliz.jpg', '/lib/emociones-dificil.jpg', null, null] },
