...
export const LIBRARIES = {
  es: [
    ...
    // ── Enganche & GFE ──
    { g: 'enganche', icon: 'Heart', name: 'Novia virtual (GFE)', scenes: ['Buenos días desde la cama', 'Antes de dormir', 'Te extrañé hoy', 'Ojalá estuvieras aquí'], imgs: ['/lib/gfe-buenosdias.jpg', '/lib/gfe-dormir.jpg', '/lib/gfe-extrane.jpg', null] },
  ...
  en: [
    ...
    // ── Engagement & GFE ──
    { g: 'enganche', icon: 'Heart', name: 'Virtual girlfriend (GFE)', scenes: ['Good morning from bed', 'Before bed', 'Missed you today', 'Wish you were here'], imgs: ['/lib/gfe-buenosdias.jpg', '/lib/gfe-dormir.jpg', '/lib/gfe-extrane.jpg', null] },
