...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'Sparkles', name: 'Coqueteo', scenes: ['Mordiéndome el labio', 'Guiño para ti', 'Bailando para ti', 'Selfie al espejo'], imgs: ['/lib/coqueteo-labio.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'Sparkles', name: 'Flirting', scenes: ['Biting my lip', 'A wink for you', 'Dancing for you', 'Mirror selfie'], imgs: ['/lib/coqueteo-labio.jpg', null, null, null] },
