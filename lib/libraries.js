...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'Gift', name: 'Regalos & wishlist', scenes: ['Abriendo tu regalo', 'Mi wishlist', 'Gracias por el detalle', 'Usando lo que me diste'], imgs: ['/lib/regalos-abriendo.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'Gift', name: 'Gifts & wishlist', scenes: ['Opening your gift', 'My wishlist', 'Thanks for the gift', 'Wearing what you gave me'], imgs: ['/lib/regalos-abriendo.jpg', null, null, null] },
