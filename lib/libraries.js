...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Route', name: 'Moto & aventura', scenes: ['En la moto', 'Casco y cuero', 'Carretera abierta', 'Escapada'], imgs: ['/lib/moto-enlamoto.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Route', name: 'Bike & adventure', scenes: ['On the bike', 'Helmet and leather', 'Open road', 'Getaway'], imgs: ['/lib/moto-enlamoto.jpg', null, null, null] },
