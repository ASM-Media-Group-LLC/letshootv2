...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Target', name: 'Pedidos personalizados', scenes: ['Tu pedido especial', 'Hecho solo para ti', 'Lo que me pediste', 'Custom exclusivo'], imgs: ['/lib/pedidos-especial.jpg', '/lib/pedidos-parati.jpg', '/lib/pedidos-loquepediste.jpg', null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Target', name: 'Custom requests', scenes: ['Your special request', 'Made just for you', 'What you asked for', 'Exclusive custom'], imgs: ['/lib/pedidos-especial.jpg', '/lib/pedidos-parati.jpg', '/lib/pedidos-loquepediste.jpg', null] },
