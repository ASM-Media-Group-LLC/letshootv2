...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'Brush', name: 'Belleza', scenes: ['Haciéndome las uñas', 'En el salón', 'Maquillándome', 'Rutina de skincare'], imgs: ['/lib/belleza-unas.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'Brush', name: 'Beauty', scenes: ['Getting my nails done', 'At the salon', 'Doing my makeup', 'Skincare routine'], imgs: ['/lib/belleza-unas.jpg', null, null, null] },
