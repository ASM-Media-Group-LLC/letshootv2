...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Dices', name: 'Tú decides', scenes: ['Elige mi outfit', 'Verdad o reto', 'Rueda de la suerte', 'Tú mandas hoy'], imgs: ['/lib/tudecides-outfit.jpg', '/lib/tudecides-verdad.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Dices', name: 'You decide', scenes: ['Pick my outfit', 'Truth or dare', 'Spin the wheel', 'You’re in charge today'], imgs: ['/lib/tudecides-outfit.jpg', '/lib/tudecides-verdad.jpg', null, null] },
