...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'PawPrint', name: 'Mascotas', scenes: ['Paseando al perro', 'Jugando con mi gato', 'En el veterinario', 'Sofá con mi mascota'], imgs: ['/lib/mascotas-perro.jpg', '/lib/mascotas-gato.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'PawPrint', name: 'Pets', scenes: ['Walking my dog', 'Playing with my cat', 'At the vet', 'Couch with my pet'], imgs: ['/lib/mascotas-perro.jpg', '/lib/mascotas-gato.jpg', null, null] },
