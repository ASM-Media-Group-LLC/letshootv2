...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', emoji: '🎙️', name: 'Notas de voz', soon: true, scenes: ['Audio solo para ti', 'Susurro', 'Contándote mi día', 'Risa grabada'] },
  ...
  en: [
    ...
    { g: 'enganche', emoji: '🎙️', name: 'Voice notes', soon: true, scenes: ['Audio just for you', 'A whisper', 'Telling you my day', 'Recorded laugh'] },
