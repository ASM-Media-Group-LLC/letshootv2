...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'Quote', name: 'Confesiones', scenes: ['Te cuento un secreto', 'Nunca se lo he dicho a nadie', 'Mi fantasía', 'Pregúntame lo que quieras'], imgs: ['/lib/confesiones-secreto.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'Quote', name: 'Confessions', scenes: ['Let me tell you a secret', 'I’ve never told anyone', 'My fantasy', 'Ask me anything'], imgs: ['/lib/confesiones-secreto.jpg', null, null, null] },
