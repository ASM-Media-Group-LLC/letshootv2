...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Shirt', name: 'Roles profesionales', scenes: ['Oficinista', 'Enfermera', 'Azafata', 'Profesora'], imgs: ['/lib/roles-oficinista.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Shirt', name: 'Professional roles', scenes: ['Office worker', 'Nurse', 'Flight attendant', 'Teacher'], imgs: ['/lib/roles-oficinista.jpg', null, null, null] },
