...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'BedDouble', name: 'Despertar juntos', scenes: ['Sábanas revueltas', 'Desayuno en cama', 'Buenos días perezosos', 'Abrazo de almohada'], imgs: ['/lib/despertar-sabanas.jpg', '/lib/despertar-desayuno.jpg', '/lib/despertar-perezoso.jpg', null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'BedDouble', name: 'Waking up together', scenes: ['Messy sheets', 'Breakfast in bed', 'Lazy good morning', 'Pillow hug'], imgs: ['/lib/despertar-sabanas.jpg', '/lib/despertar-desayuno.jpg', '/lib/despertar-perezoso.jpg', null] },
