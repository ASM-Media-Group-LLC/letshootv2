...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Film', name: 'Roleplay cinematográfico', scenes: ['Escena de película', 'Personaje misterioso', 'Historia por capítulos', 'Final alternativo'], imgs: ['/lib/cine-escena.jpg', '/lib/cine-misterioso.jpg', '/lib/cine-capitulos.jpg', null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Film', name: 'Cinematic roleplay', scenes: ['Movie scene', 'Mystery character', 'Story in chapters', 'Alternate ending'], imgs: ['/lib/cine-escena.jpg', '/lib/cine-misterioso.jpg', '/lib/cine-capitulos.jpg', null] },
