...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'Moon', name: 'Madrugada', scenes: ['No puedo dormir', 'Mensaje de las 2 a.m.', 'Despierta conmigo', 'Insomnio contigo'], imgs: ['/lib/madrugada-nodormir.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'Moon', name: 'Late night', scenes: ['Can’t sleep', '2 a.m. message', 'Stay up with me', 'Insomnia with you'], imgs: ['/lib/madrugada-nodormir.jpg', null, null, null] },
