...
export const LIBRARIES = {
  es: [
    ...
    { g: 'enganche', icon: 'Clapperboard', name: 'Detrás de cámaras', scenes: ['Antes de la foto', 'Bloopers', 'Cómo se hizo', 'En el set'], imgs: ['/lib/bts-antes.jpg', '/lib/bts-bloopers.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'enganche', icon: 'Clapperboard', name: 'Behind the scenes', scenes: ['Before the shot', 'Bloopers', 'How it was made', 'On set'], imgs: ['/lib/bts-antes.jpg', '/lib/bts-bloopers.jpg', null, null] },
