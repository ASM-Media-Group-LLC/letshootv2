...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'CalendarDays', name: 'Rutina de la semana', scenes: ['Lunes flojo', 'Mitad de semana', 'Viernes de salida', 'Domingo en pijama'], imgs: ['/lib/rutina-lunes.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'CalendarDays', name: 'Weekly routine', scenes: ['Lazy Monday', 'Midweek', 'Friday night out', 'Sunday in pajamas'], imgs: ['/lib/rutina-lunes.jpg', null, null, null] },
