...
export const LIBRARIES = {
  es: [
    // ── Tu día a día ──
    { g: 'dia', icon: 'Dumbbell', name: 'Gimnasio', scenes: ['Camino al gimnasio', 'Entrenando', 'Descansando entre series', 'Post-entreno'], imgs: ['/lib/gimnasio-camino.jpg', '/lib/gimnasio-entrenando.jpg', '/lib/gimnasio-descansando.jpg', null] },
    { g: 'dia', icon: 'UtensilsCrossed', name: 'Comida', scenes: ['Preparando desayuno', 'Cocinando', 'Cenando', 'Pidiendo comida'] },
    { g: 'dia', icon: 'ShoppingBag', name: 'Compras', scenes: ['Comprando ropa', 'Comprando lencería', 'Supermercado', 'Comprando maquillaje'] },
    { g: 'dia', icon: 'Brush', name: 'Belleza', scenes: ['Haciéndome las uñas', 'En el salón', 'Maquillándome', 'Rutina de skincare'] },
    { g: 'dia', icon: 'Car', name: 'Transporte', scenes: ['En el carro', 'En Uber', 'En tráfico', 'Buscando parqueo'] },
    { g: 'dia', icon: 'Home', name: 'Casa', scenes: ['Recién despertando', 'Limpiando', 'Organizando el cuarto', 'Viendo una película'] },
    { g: 'dia', icon: 'Briefcase', name: 'Trabajo', scenes: ['Contestando mensajes', 'Grabando contenido', 'Sesión de fotos', 'Planeando la semana'] },
    { g: 'dia', icon: 'PawPrint', name: 'Mascotas', scenes: ['Paseando al perro', 'Jugando con mi gato', 'En el veterinario', 'Sofá con mi mascota'] },
    { g: 'dia', icon: 'CloudRain', name: 'Día de lluvia', scenes: ['Lluvia y manta', 'Café y sudadera', 'Peli en la cama', 'Ventana empañada'] },
    { g: 'dia', icon: 'CalendarDays', name: 'Rutina de la semana', scenes: ['Lunes flojo', 'Mitad de semana', 'Viernes de salida', 'Domingo en pijama'] },

    // ── Enganche & GFE ──
    { g: 'enganche', icon: 'Heart', name: 'Novia virtual (GFE)', scenes: ['Buenos días desde la cama', 'Antes de dormir', 'Te extrañé hoy', 'Ojalá estuvieras aquí'] },
    { g: 'enganche', icon: 'Smile', name: 'Emociones', scenes: ['Hoy estoy feliz', 'Tuve un día difícil', 'Me siento sola', 'Estoy emocionada por algo'] },
    { g: 'enganche', icon: 'Moon', name: 'Madrugada', scenes: ['No puedo dormir', 'Mensaje de las 2 a.m.', 'Despierta conmigo', 'Insomnio contigo'] },
    { g: 'enganche', icon: 'PartyPopper', name: 'Hitos contigo', scenes: ['1 mes juntos', 'Aniversario de suscripción', 'Gracias por estar', 'Nuestro recuerdo'] },
    { g: 'enganche', icon: 'Quote', name: 'Confesiones', scenes: ['Te cuento un secreto', 'Nunca se lo he dicho a nadie', 'Mi fantasía', 'Pregúntame lo que quieras'] },
    { g: 'enganche', icon: 'Sparkles', name: 'Coqueteo', scenes: ['Mordiéndome el labio', 'Guiño para ti', 'Bailando para ti', 'Selfie al espejo'] },
    { g: 'enganche', icon: 'BedDouble', name: 'Despertar juntos', scenes: ['Sábanas revueltas', 'Desayuno en cama', 'Buenos días perezosos', 'Abrazo de almohada'] },
    { g: 'enganche', icon: 'HeartHandshake', name: 'Fantasía de pareja', scenes: ['Tu novia', 'Cena romántica en casa', 'Nuestra rutina', 'Planes juntos'] },
    { g: 'enganche', icon: 'Clapperboard', name: 'Detrás de cámaras', scenes: ['Antes de la foto', 'Bloopers', 'Cómo se hizo', 'En el set'] },
    { g: 'enganche', icon: 'Gift', name: 'Regalos & wishlist', scenes: ['Abriendo tu regalo', 'Mi wishlist', 'Gracias por el detalle', 'Usando lo que me diste'] },

    // ── Fantasía & roleplay ──
    { g: 'fantasia', icon: 'Drama', name: 'POV / Fantasía', scenes: ['POV: llegaste a casa', 'POV: primera cita', 'POV: te desperté', 'Tu vecina traviesa'] },
    { g: 'fantasia', icon: 'Shirt', name: 'Roles profesionales', scenes: ['Oficinista', 'Enfermera', 'Azafata', 'Profesora'] },
    { g: 'fantasia', icon: 'Ghost', name: 'Disfraces', scenes: ['Halloween', 'Cosplay', 'Fiesta temática', 'Personaje favorito'] },
    { g: 'fantasia', icon: 'Film', name: 'Roleplay cinematográfico', scenes: ['Escena de película', 'Personaje misterioso', 'Historia por capítulos', 'Final alternativo'] },
  ...
  en: [
    // ── Day-to-day ──
    { g: 'dia', icon: 'Dumbbell', name: 'Gym', scenes: ['On my way to the gym', 'Working out', 'Resting between sets', 'Post-workout'], imgs: ['/lib/gimnasio-camino.jpg', '/lib/gimnasio-entrenando.jpg', '/lib/gimnasio-descansando.jpg', null] },
    { g: 'dia', icon: 'UtensilsCrossed', name: 'Food', scenes: ['Making breakfast', 'Cooking', 'Having dinner', 'Ordering in'] },
    { g: 'dia', icon: 'ShoppingBag', name: 'Shopping', scenes: ['Shopping for clothes', 'Shopping for lingerie', 'Grocery run', 'Buying makeup'] },
    { g: 'dia', icon: 'Brush', name: 'Beauty', scenes: ['Getting my nails done', 'At the salon', 'Doing my makeup', 'Skincare routine'] },
    { g: 'dia', icon: 'Car', name: 'Transport', scenes: ['In the car', 'In an Uber', 'Stuck in traffic', 'Looking for parking'] },
    { g: 'dia', icon: 'Home', name: 'Home', scenes: ['Just waking up', 'Cleaning', 'Tidying my room', 'Watching a movie'] },
    { g: 'dia', icon: 'Briefcase', name: 'Work', scenes: ['Answering messages', 'Filming content', 'At a photo shoot', 'Planning the week'] },
    { g: 'dia', icon: 'PawPrint', name: 'Pets', scenes: ['Walking my dog', 'Playing with my cat', 'At the vet', 'Couch with my pet'] },
    { g: 'dia', icon: 'CloudRain', name: 'Rainy day', scenes: ['Rain and a blanket', 'Coffee and a hoodie', 'Movie in bed', 'Foggy window'] },
    { g: 'dia', icon: 'CalendarDays', name: 'Weekly routine', scenes: ['Lazy Monday', 'Midweek', 'Friday night out', 'Sunday in pajamas'] },

    // ── Engagement & GFE ──
    { g: 'enganche', icon: 'Heart', name: 'Virtual girlfriend (GFE)', scenes: ['Good morning from bed', 'Before bed', 'Missed you today', 'Wish you were here'] },
    { g: 'enganche', icon: 'Smile', name: 'Emotions', scenes: ['Feeling happy today', 'Had a rough day', 'Feeling lonely', 'Excited about something'] },
    { g: 'enganche', icon: 'Moon', name: 'Late night', scenes: ['Can’t sleep', '2 a.m. message', 'Stay up with me', 'Insomnia with you'] },
    { g: 'enganche', icon: 'PartyPopper', name: 'Milestones with you', scenes: ['1 month together', 'Subscription anniversary', 'Thanks for being here', 'Our memory'] },
    { g: 'enganche', icon: 'Quote', name: 'Confessions', scenes: ['Let me tell you a secret', 'I’ve never told anyone', 'My fantasy', 'Ask me anything'] },
    { g: 'enganche', icon: 'Sparkles', name: 'Flirting', scenes: ['Biting my lip', 'A wink for you', 'Dancing for you', 'Mirror selfie'] },
    { g: 'enganche', icon: 'BedDouble', name: 'Waking up together', scenes: ['Messy sheets', 'Breakfast in bed', 'Lazy good morning', 'Pillow hug'] },
    { g: 'enganche', icon: 'HeartHandshake', name: 'Couple fantasy', scenes: ['Your girlfriend', 'Romantic dinner at home', 'Our routine', 'Plans together'] },
    { g: 'enganche', icon: 'Clapperboard', name: 'Behind the scenes', scenes: ['Before the shot', 'Bloopers', 'How it was made', 'On set'] },
    { g: 'enganche', icon: 'Gift', name: 'Gifts & wishlist', scenes: ['Opening your gift', 'My wishlist', 'Thanks for the gift', 'Wearing what you gave me'] },

    // ── Fantasy & roleplay ──
    { g: 'fantasia', icon: 'Drama', name: 'POV / Fantasy', scenes: ['POV: you got home', 'POV: first date', 'POV: I woke you up', 'Your naughty neighbor'] },
    { g: 'fantasia', icon: 'Shirt', name: 'Professional roles', scenes: ['Office worker', 'Nurse', 'Flight attendant', 'Teacher'] },
    { g: 'fantasia', icon: 'Ghost', name: 'Costumes', scenes: ['Halloween', 'Cosplay', 'Themed party', 'Favorite character'] },
    { g: 'fantasia', icon: 'Film', name: 'Cinematic roleplay', scenes: ['Movie scene', 'Mystery character', 'Story in chapters', 'Alternate ending'] },
