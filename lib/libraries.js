...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'GraduationCap', name: 'Universidad', scenes: ['Estudiando tarde', 'Uniforme', 'En la biblioteca', 'Examen aprobado'], imgs: ['/lib/universidad-estudiando.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'GraduationCap', name: 'College', scenes: ['Studying late', 'Uniform', 'At the library', 'Passed the exam'], imgs: ['/lib/universidad-estudiando.jpg', null, null, null] },
