...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'UtensilsCrossed', name: 'Comida', scenes: ['Preparando desayuno', 'Cocinando', 'Cenando', 'Pidiendo comida'], imgs: ['/lib/comida-desayuno.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'UtensilsCrossed', name: 'Food', scenes: ['Making breakfast', 'Cooking', 'Having dinner', 'Ordering in'], imgs: ['/lib/comida-desayuno.jpg', null, null, null] },
