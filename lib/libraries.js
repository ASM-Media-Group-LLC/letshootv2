...
export const LIBRARIES = {
  es: [
    ...
    { g: 'venta', icon: 'Flame', name: 'Provocación', scenes: ['Nueva lencería', '¿Adivina qué llevo?', 'Cambio de outfit', 'Debajo del vestido'], imgs: ['/lib/venta-nueva-lenceria.jpg', '/lib/venta-adivina.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'venta', icon: 'Flame', name: 'Teasing', scenes: ['New lingerie', 'Guess what I’m wearing', 'Outfit change', 'Under the dress'], imgs: ['/lib/venta-nueva-lenceria.jpg', '/lib/venta-adivina.jpg', null, null] },
