...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Ghost', name: 'Disfraces', scenes: ['Halloween', 'Cosplay', 'Fiesta temática', 'Personaje favorito'], imgs: ['/lib/disfraces-halloween.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Ghost', name: 'Costumes', scenes: ['Halloween', 'Cosplay', 'Themed party', 'Favorite character'], imgs: ['/lib/disfraces-halloween.jpg', null, null, null] },
