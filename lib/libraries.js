...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'Car', name: 'Transporte', scenes: ['En el carro', 'En Uber', 'En tráfico', 'Buscando parqueo'], imgs: ['/lib/transporte-carro.jpg', '/lib/transporte-uber.jpg', null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'Car', name: 'Transport', scenes: ['In the car', 'In an Uber', 'Stuck in traffic', 'Looking for parking'], imgs: ['/lib/transporte-carro.jpg', '/lib/transporte-uber.jpg', null, null] },
