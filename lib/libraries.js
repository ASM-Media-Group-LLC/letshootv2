...
export const LIBRARIES = {
  es: [
    ...
    { g: 'fantasia', icon: 'Gamepad2', name: 'Gamer', scenes: ['Jugando de noche', 'Setup gamer', 'Perdí la apuesta', 'Jugamos juntos'], imgs: ['/lib/gamer-noche.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'fantasia', icon: 'Gamepad2', name: 'Gamer', scenes: ['Playing at night', 'Gamer setup', 'I lost the bet', 'Playing together'], imgs: ['/lib/gamer-noche.jpg', null, null, null] },
