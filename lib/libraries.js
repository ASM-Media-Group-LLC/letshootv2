...
export const LIBRARIES = {
  es: [
    ...
    // ── Fantasía & roleplay ──
    { g: 'fantasia', icon: 'Drama', name: 'POV / Fantasía', scenes: ['POV: llegaste a casa', 'POV: primera cita', 'POV: te desperté', 'Tu vecina traviesa'], imgs: ['/lib/pov-casa.jpg', '/lib/pov-cita.jpg', '/lib/pov-desperte.jpg', null] },
  ...
  en: [
    ...
    // ── Fantasy & roleplay ──
    { g: 'fantasia', icon: 'Drama', name: 'POV / Fantasy', scenes: ['POV: you got home', 'POV: first date', 'POV: I woke you up', 'Your naughty neighbor'], imgs: ['/lib/pov-casa.jpg', '/lib/pov-cita.jpg', '/lib/pov-desperte.jpg', null] },
