...
export const LIBRARIES = {
  es: [
    ...
    { g: 'dia', icon: 'ShoppingBag', name: 'Compras', scenes: ['Comprando ropa', 'Comprando lencería', 'Supermercado', 'Comprando maquillaje'], imgs: ['/lib/compras-ropa.jpg', null, null, null] },
  ...
  en: [
    ...
    { g: 'dia', icon: 'ShoppingBag', name: 'Shopping', scenes: ['Shopping for clothes', 'Shopping for lingerie', 'Grocery run', 'Buying makeup'], imgs: ['/lib/compras-ropa.jpg', null, null, null] },
