...
const COPY = {
  ...
  de: {
    eyebrow: 'Für OnlyFans-Agenturen',
    h1a: 'Content skalieren für jedes Model',
    h1b: 'in Ihrem Roster.',
    sub: 'Ein Dashboard. Jede Creatorin, jeden Tag, jede Situation. Interaktion direkt auf OnlyFans, Traffic aus Social Media — für Ihre gesamte Agentur auf einmal.',
    ctaPrimary: 'Als Agentur registrieren',
    ctaSecondary: 'Anmelden',
    platformsSellOn: 'Interaktion auf',
    platformsTrafficFrom: 'und Traffic gewinnen aus',
    valueLabel: 'Gemacht für Agenturen',
    valueTitle: 'Was Sie bekommen, wenn Ihr gesamtes Roster auf LetShoot läuft',
    valueSub: 'Nicht nur Content — die Betriebsebene darunter. Auf Volumen ausgelegt, für Wachstum gebaut.',
    cards: [
      { icon: Users, title: 'Jede Creatorin, täglich', body: 'Verkaufsfertige Fotos und Videos für jedes Model in Ihrem Roster — jeden Tag geliefert, ohne Shootings, ohne Verzögerungen.' },
      { icon: TrendingUp, title: 'Traffic-fertige Assets', body: 'Content, der für Instagram, Reddit, TikTok, Telegram und X gemacht ist — Interaktion, die Fans zu OnlyFans zieht.' },
      { icon: LayoutDashboard, title: 'Ein Dashboard', body: 'Produktion, Verkäufe und Anfragen für jedes Model an einem Ort. Weisen Sie Mitarbeiter einzelnen Creatorinnen mit fein abgestuften Zugriffsrechten zu.' },
      { icon: Building2, title: 'Agentur-Preise', body: 'Ein Tarif für Ihr gesamtes Roster. Keine Gebühren pro Shooting. Sprechen Sie mit uns — wir gestalten den Volumentarif rund um Ihren Betrieb.' },
    ],
    finalTitle: 'Bereit, Ihre gesamte Agentur von einem Ort aus zu steuern?',
    finalSub: 'Erzählen Sie uns von Ihrem Betrieb und wir richten alles für Sie ein.',
    formTitle: 'Registrieren Sie Ihre Agentur',
    formSub: 'Nennen Sie uns die Basics. Wir melden uns innerhalb von 24 Stunden, um alles einzurichten.',
    fName: 'Name der Agentur', fNamePh: 'z. B. Kash Agency',
    fEmail: 'Kontakt-E-Mail', fEmailPh: 'sie@agentur.com',
    fSite: 'Website oder Social', fSitePh: 'agentur.com · @handle',
    fCount: 'Wie viele Creatorinnen?', fCountPh: '1–5, 6–20, 20+',
    fNotes: 'Sonst noch etwas', fNotesPh: 'Regionen, Fokus, aktueller Stack…',
    submit: 'Registrierung absenden', submitting: 'Wird gesendet…',
    thanksTitle: 'Alles klar — wir melden uns',
    thanksBody: 'Danke für Ihr Interesse. Wir schreiben Ihnen innerhalb von 24 Stunden von hello@letshoot.ai, um Ihren Agentur-Workspace einzurichten.',
    close: 'Schließen',
  },
  it: {
    eyebrow: 'Per agenzie OnlyFans',
    h1a: 'Scala i contenuti di ogni modella',
    h1b: 'del tuo roster.',
    sub: 'Un\'unica dashboard. Ogni creator, ogni giorno, ogni situazione. Coinvolgi dentro OnlyFans, porta traffico dai social — per tutta la tua agenzia in una volta sola.',
    ctaPrimary: 'Registra la tua agenzia',
    ctaSecondary: 'Accedi',
    platformsSellOn: 'Coinvolgi su',
    platformsTrafficFrom: 'e porta traffico da',
    valueLabel: 'Pensato per le agenzie',
    valueTitle: 'Cosa ottieni quando tutto il tuo roster gira su LetShoot',
    valueSub: 'Non solo contenuti — il livello operativo che ci sta sotto. Prezzi pensati per il volume, progettati per scalare.',
    cards: [
      { icon: Users, title: 'Ogni creator, ogni giorno', body: 'Foto e video pronti da vendere per ogni modella del tuo roster — consegnati ogni giorno, senza shooting, senza attese.' },
      { icon: TrendingUp, title: 'Asset pronti per il traffico', body: 'Contenuti pensati per essere pubblicati su Instagram, Reddit, TikTok, Telegram e X — coinvolgimento che porta i fan dentro OnlyFans.' },
      { icon: LayoutDashboard, title: 'Un\'unica dashboard', body: 'Vedi produzione, vendite e richieste di ogni modella in un solo posto. Assegna i collaboratori a creator specifiche con accesso granulare.' },
      { icon: Building2, title: 'Prezzi per agenzie', body: 'Un solo piano per tutto il tuo roster. Nessun costo a shooting. Parliamone — costruiamo il piano a volume su misura per la tua operatività.' },
    ],
    finalTitle: 'Pronto a gestire tutta la tua agenzia da un unico posto?',
    finalSub: 'Raccontaci della tua operatività e ti prepariamo tutto.',
    formTitle: 'Registra la tua agenzia',
    formSub: 'Raccontaci l\'essenziale. Ti ricontattiamo entro 24h per la configurazione.',
    fName: 'Nome dell\'agenzia', fNamePh: 'es. Kash Agency',
    fEmail: 'Email di contatto', fEmailPh: 'tu@agenzia.com',
    fSite: 'Sito o social', fSitePh: 'agenzia.com · @handle',
    fCount: 'Quante creator?', fCountPh: '1–5, 6–20, 20+',
    fNotes: 'Altro', fNotesPh: 'Aree geografiche, focus, stack attuale…',
    submit: 'Invia la registrazione', submitting: 'Invio in corso…',
    thanksTitle: 'Ricevuto — ti ricontattiamo',
    thanksBody: 'Grazie per il tuo interesse. Ti scriviamo entro 24h da hello@letshoot.ai per configurare il workspace della tua agenzia.',
    close: 'Chiudi',
  },
  fr: {
    eyebrow: 'Pour les agences OnlyFans',
    h1a: 'Produisez du contenu pour chaque modèle',
    h1b: 'de votre roster.',
    sub: 'Un seul tableau de bord. Chaque créatrice, chaque jour, chaque situation. Engagez au sein d\'OnlyFans, générez du trafic depuis les réseaux — pour toute votre agence à la fois.',
    ctaPrimary: 'Inscrire mon agence',
    ctaSecondary: 'Se connecter',
    platformsSellOn: 'Engagez sur',
    platformsTrafficFrom: 'et générez du trafic depuis',
    valueLabel: 'Conçu pour les agences',
    valueTitle: 'Ce que vous obtenez quand tout votre roster tourne sur LetShoot',
    valueSub: 'Pas seulement du contenu — la couche opérationnelle qui le soutient. Un tarif pensé pour le volume, une conception pensée pour l\'échelle.',
    cards: [
      { icon: Users, title: 'Chaque créatrice, chaque jour', body: 'Des photos et vidéos prêtes à vendre pour chaque modèle de votre roster — livrées chaque jour, sans séance, sans attente.' },
      { icon: TrendingUp, title: 'Des contenus prêts pour le trafic', body: 'Du contenu conçu pour publier sur Instagram, Reddit, TikTok, Telegram et X — de l\'engagement qui attire les fans vers OnlyFans.' },
      { icon: LayoutDashboard, title: 'Un seul tableau de bord', body: 'Suivez la production, les ventes et les demandes de chaque modèle au même endroit. Affectez des collaborateurs à des créatrices précises avec un accès granulaire.' },
      { icon: Building2, title: 'Tarif agence', body: 'Un seul forfait pour tout votre roster. Aucun frais par séance. Parlons-en — nous construisons le plan volume autour de votre activité.' },
    ],
    finalTitle: 'Prêt à piloter toute votre agence depuis un seul endroit ?',
    finalSub: 'Parlez-nous de votre activité et nous nous occupons de tout.',
    formTitle: 'Inscrivez votre agence',
    formSub: 'Donnez-nous l\'essentiel. Nous vous recontactons sous 24 h pour tout configurer.',
    fName: 'Nom de l\'agence', fNamePh: 'ex. Kash Agency',
    fEmail: 'E-mail de contact', fEmailPh: 'vous@agence.com',
    fSite: 'Site web ou réseaux', fSitePh: 'agence.com · @pseudo',
    fCount: 'Combien de créatrices ?', fCountPh: '1–5, 6–20, 20+',
    fNotes: 'Autre chose', fNotesPh: 'Régions, focus, outils actuels…',
    submit: 'Envoyer l\'inscription', submitting: 'Envoi…',
    thanksTitle: 'C\'est noté — nous vous recontactons',
    thanksBody: 'Merci de votre intérêt. Nous vous écrirons sous 24 h depuis hello@letshoot.ai pour configurer l\'espace de travail de votre agence.',
    close: 'Fermer',
  },};
      ...
      <section id="top" className="relative w-full bg-ink">
        <div className="relative flex min-h-[100svh] w-full flex-col justify-between overflow-hidden">
          ...
          <motion.div
            ...
            className="relative z-10 flex w-full flex-1 items-start pt-24 sm:pt-28"
          >
